...
- [GitHub Action run](https://github.com/facebookexperimental/free-threading-benchmarking/actions/runs/19650854547)
...
- Geometric mean: 1.631x faster (HPT: reliability of 91.01%, 1.00x faster at 99th %ile)
- Memory usage: 1.60x
...
- Geometric mean: 1.540x faster (HPT: reliability of 91.01%, 1.00x faster at 99th %ile)
- Memory usage: 1.34x
