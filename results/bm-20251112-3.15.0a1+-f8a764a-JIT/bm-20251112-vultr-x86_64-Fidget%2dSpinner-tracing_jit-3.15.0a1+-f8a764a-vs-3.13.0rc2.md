...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.13.0rc2-3.13.0rc2-ec61006 | bm-20251112-vultr-x86_64-Fidget%2dSpinner-tracing_jit-3.15.0a1+-f8a764a |
|----------------|:------------------------------------------------------------:|:-----------------------------------------------------------------------:|
...
| Benchmark                  | bm-20240906-vultr-x86_64-python-v3.13.0rc2-3.13.0rc2-ec61006 | bm-20251112-vultr-x86_64-Fidget%2dSpinner-tracing_jit-3.15.0a1+-f8a764a |
|----------------------------|:------------------------------------------------------------:|:-----------------------------------------------------------------------:|
| richards                   | 45.2 ms                                                      | 21.7 ms: 2.08x faster                                                   |
| richards_super             | 51.6 ms                                                      | 26.0 ms: 1.99x faster                                                   |
...
| scimark_sor                | 134 ms                                                       | 96.7 ms: 1.39x faster                                                   |
| async_tree_cpu_io_mixed    | 666 ms                                                       | 484 ms: 1.38x faster                                                    |
| scimark_fft                | 349 ms                                                       | 254 ms: 1.38x faster                                                    |
| async_tree_none_tg         | 336 ms                                                       | 245 ms: 1.37x faster                                                    |
| go                         | 141 ms                                                       | 103 ms: 1.36x faster                                                    |
| spectral_norm              | 111 ms                                                       | 82.3 ms: 1.35x faster                                                   |
| async_tree_memoization_tg  | 414 ms                                                       | 308 ms: 1.34x faster                                                    |
| async_tree_cpu_io_mixed_tg | 638 ms                                                       | 485 ms: 1.31x faster                                                    |
| float                      | 77.5 ms                                                      | 59.4 ms: 1.30x faster                                                   |
...
Benchmark hidden because not significant (5): pylint, pycparser, generators, json, pickle_pure_python
