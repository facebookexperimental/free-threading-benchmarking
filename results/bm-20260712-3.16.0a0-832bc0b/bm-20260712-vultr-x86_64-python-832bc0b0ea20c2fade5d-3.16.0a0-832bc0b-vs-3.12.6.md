...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260712-vultr-x86_64-python-832bc0b0ea20c2fade5d-3.16.0a0-832bc0b |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
...
| nbody          | 89.3 ms                                                | 96.9 ms: 1.09x slower                                                 |
...
| bench_mp_pool              | 10.8 ms                                                | 233 ms: 21.55x slower                                                 |
| telco                      | 6.53 ms                                                | 157 ms: 24.06x slower                                                 |
| Geometric mean             | (ref)                                                  | 1.02x faster                                                          |

Benchmark hidden because not significant (3): json, sqlite_synth, thrift
