...
| tomli_loads                | 2.01 sec                                                     | 2.18 sec: 1.09x slower                                                 |
| python_startup             | 11.0 ms                                                      | 12.4 ms: 1.13x slower                                                  |
| gc_traversal               | 3.14 ms                                                      | 4.12 ms: 1.31x slower                                                  |
| create_gc_cycles           | 1.34 ms                                                      | 1.86 ms: 1.39x slower                                                  |
| bench_thread_pool          | 919 us                                                       | 1.32 ms: 1.43x slower                                                  |
| telco                      | 7.82 ms                                                      | 159 ms: 20.32x slower                                                  |
| bench_mp_pool              | 11.0 ms                                                      | 320 ms: 29.13x slower                                                  |
| Geometric mean             | (ref)                                                        | 1.01x slower                                                           |

Benchmark hidden because not significant (4): typing_runtime_protocols, nqueens, raytrace, nbody
