...
| python_startup             | 9.93 ms                                                | 16.1 ms: 1.63x slower                                                  |
| telco                      | 6.53 ms                                                | 171 ms: 26.24x slower                                                  |
| Geometric mean             | (ref)                                                  | 1.02x slower                                                           |

Benchmark hidden because not significant (4): generators, deltablue, docutils, coroutines
...
- Reliability score: 52.10% likely to be slow
