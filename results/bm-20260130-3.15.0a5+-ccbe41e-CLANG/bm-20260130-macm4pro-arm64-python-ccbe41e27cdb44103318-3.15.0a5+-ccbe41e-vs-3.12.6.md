...
| async_tree_none_tg               | 172 ms                                                   | 93.0 ms: 1.85x faster                                                    |
| async_tree_none                  | 178 ms                                                   | 96.6 ms: 1.84x faster                                                    |
...
| async_tree_eager                 | 45.6 ms                                                  | 38.4 ms: 1.19x faster                                                    |
...
| Benchmark                        | bm-20240906-macm4pro-arm64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260130-macm4pro-arm64-python-ccbe41e27cdb44103318-3.15.0a5+-ccbe41e |
|----------------------------------|:--------------------------------------------------------:|:------------------------------------------------------------------------:|
| subparsers                       | 20.8 ms                                                  | 3.75 ms: 5.54x faster                                                    |
| async_tree_eager_io              | 496 ms                                                   | 210 ms: 2.36x faster                                                     |
| async_tree_io_tg                 | 480 ms                                                   | 218 ms: 2.20x faster                                                     |
| async_tree_io                    | 459 ms                                                   | 215 ms: 2.14x faster                                                     |
...
| async_tree_none_tg               | 172 ms                                                   | 93.0 ms: 1.85x faster                                                    |
| async_tree_none                  | 178 ms                                                   | 96.6 ms: 1.84x faster                                                    |
| deepcopy                         | 161 us                                                   | 92.0 us: 1.76x faster                                                    |
| async_tree_memoization_tg        | 231 ms                                                   | 132 ms: 1.75x faster                                                     |
| async_tree_memoization           | 223 ms                                                   | 133 ms: 1.68x faster                                                     |
...
| nbody                            | 54.2 ms                                                  | 45.8 ms: 1.18x faster                                                    |
| scimark_lu                       | 51.3 ms                                                  | 43.3 ms: 1.18x faster                                                    |
...
| sphinx                           | 434 ms                                                   | 378 ms: 1.15x faster                                                     |
| genshi_xml                       | 21.8 ms                                                  | 19.2 ms: 1.13x faster                                                    |
| sympy_integrate                  | 8.02 ms                                                  | 7.09 ms: 1.13x faster                                                    |
| unpickle_pure_python             | 103 us                                                   | 91.5 us: 1.13x faster                                                    |
| html5lib                         | 23.0 ms                                                  | 20.6 ms: 1.12x faster                                                    |
...
| sympy_str                        | 104 ms                                                   | 95.0 ms: 1.10x faster                                                    |
