...
- Geometric mean: 1.007x slower (HPT: reliability of 54.58%, 1.00x slower at 99th %ile)
- Memory usage: 1.44x
...
- Geometric mean: 1.040x slower (HPT: reliability of 66.00%, 1.00x slower at 99th %ile)
- Memory usage: 1.43x
...
- Memory usage: 1.21x
- [🧠memory plot](bm-20260419-vultr-x86_64-python-e50acef0b2c2057874a9-3.15.0a8%2B-e50acef-vs-base-mem.svg)
- [📄table](bm-20260419-vultr-x86_64-python-e50acef0b2c2057874a9-3.15.0a8%2B-e50acef-vs-base.md)
- [📈time plot](bm-20260419-vultr-x86_64-python-e50acef0b2c2057874a9-3.15.0a8%2B-e50acef-vs-base.svg)
...
- Geometric mean: 1.099x faster (HPT: reliability of 99.52%, 1.00x faster at 99th %ile)
- Memory usage: 1.39x
...
- Geometric mean: 1.020x faster (HPT: reliability of 55.46%, 1.00x faster at 99th %ile)
- Memory usage: 1.33x
- missing benchmarks: chameleon, djangocms, gevent_hub, sqlalchemy_declarative, sqlalchemy_imperative, sqlglot_normalize, sqlglot_optimize, sqlglot_parse, sqlglot_transpile, tornado_http
- new benchmarks: sqlglot_v2_normalize, sqlglot_v2_optimize, sqlglot_v2_parse, sqlglot_v2_transpile
...
- Memory usage: 1.12x
- [🧠memory plot](bm-20260419-macm4pro-arm64-python-e50acef0b2c2057874a9-3.15.0a8%2B-e50acef-vs-base-mem.svg)
- [📄table](bm-20260419-macm4pro-arm64-python-e50acef0b2c2057874a9-3.15.0a8%2B-e50acef-vs-base.md)
- [📈time plot](bm-20260419-macm4pro-arm64-python-e50acef0b2c2057874a9-3.15.0a8%2B-e50acef-vs-base.svg)
