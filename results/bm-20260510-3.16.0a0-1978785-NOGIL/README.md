...
- Geometric mean: 1.040x slower (HPT: reliability of 90.84%, 1.00x slower at 99th %ile)
- Memory usage: 1.39x
...
- Geometric mean: 1.074x slower (HPT: reliability of 99.88%, 1.01x slower at 99th %ile)
- Memory usage: 1.38x
...
- Memory usage: 1.19x
- [🧠memory plot](bm-20260510-vultr-x86_64-python-197878529f20566c1e47-3.16.0a0-1978785-vs-base-mem.svg)
- [📄table](bm-20260510-vultr-x86_64-python-197878529f20566c1e47-3.16.0a0-1978785-vs-base.md)
- [📈time plot](bm-20260510-vultr-x86_64-python-197878529f20566c1e47-3.16.0a0-1978785-vs-base.svg)
...
- Geometric mean: 1.096x faster (HPT: reliability of 99.57%, 1.00x faster at 99th %ile)
- Memory usage: 1.34x
...
- Geometric mean: 1.012x faster (HPT: reliability of 65.70%, 1.00x slower at 99th %ile)
- Memory usage: 1.29x
- missing benchmarks: 2to3, chameleon, djangocms, genshi_text, genshi_xml, gevent_hub, python_startup, python_startup_no_site, sqlalchemy_declarative, sqlalchemy_imperative, sqlglot_normalize, sqlglot_optimize, sqlglot_parse, sqlglot_transpile, tornado_http
- new benchmarks: sqlglot_v2_normalize, sqlglot_v2_optimize, sqlglot_v2_parse, sqlglot_v2_transpile
...
- Memory usage: 1.11x
- [🧠memory plot](bm-20260510-macm4pro-arm64-python-197878529f20566c1e47-3.16.0a0-1978785-vs-base-mem.svg)
- [📄table](bm-20260510-macm4pro-arm64-python-197878529f20566c1e47-3.16.0a0-1978785-vs-base.md)
- [📈time plot](bm-20260510-macm4pro-arm64-python-197878529f20566c1e47-3.16.0a0-1978785-vs-base.svg)
