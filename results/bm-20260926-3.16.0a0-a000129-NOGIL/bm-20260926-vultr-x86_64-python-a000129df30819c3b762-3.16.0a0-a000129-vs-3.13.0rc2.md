...
| async_tree_none            | 353 ms                                                                 | 371 ms: 1.05x slower                                                  |
| coroutines                 | 23.3 ms                                                                | 25.5 ms: 1.09x slower                                                 |
| async_generators           | 375 ms                                                                 | 417 ms: 1.11x slower                                                  |
...
| float          | 76.7 ms                                                                | 84.8 ms: 1.10x slower                                                 |
...
| xml_etree_iterparse  | 94.4 ms                                                                | 97.2 ms: 1.03x slower                                                 |
...
| Benchmark              | bm-20240920-vultr-x86_64-python-4981ec59ded050919eb2-3.13.0rc2-4981ec5 | bm-20260926-vultr-x86_64-python-a000129df30819c3b762-3.16.0a0-a000129 |
|------------------------|:----------------------------------------------------------------------:|:---------------------------------------------------------------------:|
| python_startup_no_site | 7.41 ms                                                                | 9.75 ms: 1.31x slower                                                 |
...
| dulwich_log                | 74.5 ms                                                                | 69.6 ms: 1.07x faster                                                 |
...
| coroutines                 | 23.3 ms                                                                | 25.5 ms: 1.09x slower                                                 |
| float                      | 76.7 ms                                                                | 84.8 ms: 1.10x slower                                                 |
| comprehensions             | 16.6 us                                                                | 18.3 us: 1.11x slower                                                 |
...
| telco                      | 7.77 ms                                                                | 175 ms: 22.51x slower                                                 |
| Geometric mean             | (ref)                                                                  | 1.08x slower                                                          |
