...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260926-vultr-x86_64-python-a000129df30819c3b762-3.16.0a0-a000129 |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
...
| float          | 80.8 ms                                                | 84.8 ms: 1.05x slower                                                 |
...
| xml_etree_iterparse  | 96.7 ms                                                | 97.2 ms: 1.00x slower                                                 |
...
Ignored benchmarks (10) of results/bm-20260926-3.16.0a0-a000129-NOGIL/bm-20260926-vultr-x86_64-python-a000129df30819c3b762-3.16.0a0-a000129.json: connected_components, k_core, many_optionals, shortest_path, sphinx, sqlglot_v2_normalize, sqlglot_v2_optimize, sqlglot_v2_parse, sqlglot_v2_transpile, subparsers

- Geometric mean (including insignificant results): 1.044x slower

# HPT report

- Reliability score: 86.07% likely to be slow
