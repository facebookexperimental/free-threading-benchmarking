...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260330-vultr-x86_64-python-70d1b08a4bb52652094c-3.15.0a7+-70d1b08 |
|----------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
...
| bench_mp_pool              | 10.8 ms                                                | 278 ms: 25.79x slower                                                  |
| Geometric mean             | (ref)                                                  | 1.03x faster                                                           |

Benchmark hidden because not significant (5): scimark_sparse_mat_mult, xml_etree_process, django_template, json, nbody
