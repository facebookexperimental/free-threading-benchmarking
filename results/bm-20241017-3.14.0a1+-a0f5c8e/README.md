...
- [GitHub Action run](https://github.com/facebookexperimental/free-threading-benchmarking/actions/runs/11396574189)
...
- Geometric mean: 1.01x faster (HPT: reliability of 67.26%, 1.00x slower at 99th %ile)
- Memory usage: 1.06x
...
- Geometric mean: 1.04x slower (HPT: reliability of 91.01%, 1.00x slower at 99th %ile)
- Memory usage: 0.97x
