...
- [GitHub Action run](https://github.com/facebookexperimental/free-threading-benchmarking/actions/runs/19842191400)
- cpu model: Intel(R) Xeon(R) E-2286G CPU @ 4.00GHz
- platform: Linux-6.8.0-87-generic-x86_64-with-glibc2.39
- [raw results](bm-20251201-vultr-x86_64-python-main-3.15.0a2%2B-eb89286.json)

### vs. 3.12.6

- Geometric mean: 1.636x faster (HPT: reliability of 91.01%, 1.00x faster at 99th %ile)
- Memory usage: 1.60x
...
- [📄table](bm-20251201-vultr-x86_64-python-main-3.15.0a2%2B-eb89286-vs-3.12.6.md)
- [📈time plot](bm-20251201-vultr-x86_64-python-main-3.15.0a2%2B-eb89286-vs-3.12.6.svg)

### vs. 3.13.0rc2

- Geometric mean: 1.545x faster (HPT: reliability of 91.01%, 1.00x faster at 99th %ile)
- Memory usage: 1.34x
...
- [📄table](bm-20251201-vultr-x86_64-python-main-3.15.0a2%2B-eb89286-vs-3.13.0rc2.md)
- [📈time plot](bm-20251201-vultr-x86_64-python-main-3.15.0a2%2B-eb89286-vs-3.13.0rc2.svg)

### vs. base

- Geometric mean: 1.491x faster (HPT: reliability of 91.01%, 1.00x faster at 99th %ile)
- Memory usage: 1.05x
...
- [🧠memory plot](bm-20251201-vultr-x86_64-python-main-3.15.0a2%2B-eb89286-vs-base-mem.svg)
- [📄table](bm-20251201-vultr-x86_64-python-main-3.15.0a2%2B-eb89286-vs-base.md)
- [📈time plot](bm-20251201-vultr-x86_64-python-main-3.15.0a2%2B-eb89286-vs-base.svg)
