...
- overall geometric mean: 1.545x faster
- HPT reliability: 91.01%
- HPT 99th percentile: 1.00x faster
- Memory change: 1.34x

| Benchmark      | bm-20240906-vultr-x86_64-python-v3.13.0rc2-3.13.0rc2-ec61006 | bm-20251201-vultr-x86_64-python-main-3.15.0a2+-eb89286 |
|----------------|:------------------------------------------------------------:|:------------------------------------------------------:|
| richards       | 45.2 ms                                                      | 21.0 ms: 2.16x faster                                  |
...
- Geometric mean (including insignificant results): 1.545x faster
