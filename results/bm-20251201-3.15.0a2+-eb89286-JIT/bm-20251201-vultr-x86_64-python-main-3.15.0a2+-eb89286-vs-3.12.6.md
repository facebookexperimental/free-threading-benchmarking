...
- overall geometric mean: 1.636x faster
- HPT reliability: 91.01%
- HPT 99th percentile: 1.00x faster
- Memory change: 1.60x

| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20251201-vultr-x86_64-python-main-3.15.0a2+-eb89286 |
|----------------|:------------------------------------------------------:|:------------------------------------------------------:|
...
- Geometric mean (including insignificant results): 1.636x faster
