...
| async_tree_io_tg                 | 480 ms                                                   | 325 ms: 1.47x faster                                                    |
...
| async_tree_cpu_io_mixed          | 333 ms                                                   | 272 ms: 1.22x faster                                                    |
...
| mako                             | 4.77 ms                                                  | 4.80 ms: 1.01x slower                                                   |
| crypto_pyaes                     | 38.8 ms                                                  | 39.6 ms: 1.02x slower                                                   |
...
| async_tree_eager_memoization_tg  | 113 ms                                                   | 150 ms: 1.33x slower                                                    |
| nqueens                          | 43.5 ms                                                  | 68.8 ms: 1.58x slower                                                   |
| async_tree_eager_tg              | 32.1 ms                                                  | 101 ms: 3.14x slower                                                    |
