...
| coverage                   | 83.0 ms                                                      | 95.8 ms: 1.15x slower                                                  |
| json_loads                 | 27.0 us                                                      | 31.3 us: 1.16x slower                                                  |
| xml_etree_process          | 59.3 ms                                                      | 68.9 ms: 1.16x slower                                                  |
| 2to3                       | 260 ms                                                       | 302 ms: 1.16x slower                                                   |
...
| nqueens                    | 78.6 ms                                                      | 94.4 ms: 1.20x slower                                                  |
...
| hexiom                     | 5.99 ms                                                      | 7.33 ms: 1.22x slower                                                  |
...
Ignored benchmarks (8) of results/bm-20250203-3.14.0a4+-bb5c687-NOGIL/bm-20250203-vultr-x86_64-python-bb5c6875d6e84bf2b4e1-3.14.0a4+-bb5c687.json: connected_components, k_core, many_optionals, shortest_path, sphinx, sqlalchemy_declarative, sqlalchemy_imperative, subparsers
