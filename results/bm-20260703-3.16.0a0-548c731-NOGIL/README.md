...
- Geometric mean: 1.036x slower (HPT: reliability of 93.84%, 1.00x slower at 99th %ile)
- Memory usage: 1.37x
...
- Geometric mean: 1.069x slower (HPT: reliability of 98.19%, 1.00x slower at 99th %ile)
- Memory usage: 1.36x
...
- Memory usage: 1.18x
- [🧠memory plot](bm-20260703-vultr-x86_64-python-548c7314138b85cab3b9-3.16.0a0-548c731-vs-base-mem.svg)
- [📄table](bm-20260703-vultr-x86_64-python-548c7314138b85cab3b9-3.16.0a0-548c731-vs-base.md)
- [📈time plot](bm-20260703-vultr-x86_64-python-548c7314138b85cab3b9-3.16.0a0-548c731-vs-base.svg)
