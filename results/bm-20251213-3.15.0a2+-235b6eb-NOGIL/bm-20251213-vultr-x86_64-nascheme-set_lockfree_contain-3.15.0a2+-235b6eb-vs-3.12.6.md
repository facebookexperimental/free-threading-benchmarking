...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20251213-vultr-x86_64-nascheme-set_lockfree_contain-3.15.0a2+-235b6eb |
|----------------|:------------------------------------------------------:|:------------------------------------------------------------------------:|
...
| python_startup             | 9.93 ms                                                | 15.9 ms: 1.60x slower                                                    |
| telco                      | 6.53 ms                                                | 177 ms: 27.14x slower                                                    |
