...
- version: 3.14.0a0
- config: NOGIL
- commit hash: [de929f3](https://github.com/python/cpython/commit/de929f3)
- commit date: 2024-09-26T05:11:17+00:00
- commit merge base: [d9296529eb0a65f988e8600d3073977dff0ce5a9](https://github.com/python/cpython/commit/d9296529eb0a65f988e8600d3073977dff0ce5a9)
...
- [raw results](bm-20240926-linux-x86_64-python-de929f353c413459834a-3.14.0a0-de929f3.json)

### vs. 3.12.6

- Geometric mean: 1.455x slower (HPT: reliability of 84.13%, 1.00x slower at 99th %ile)
- Memory usage: 1.11x
...
- [📄table](bm-20240926-linux-x86_64-python-de929f353c413459834a-3.14.0a0-de929f3-vs-3.12.6.md)
- [📈time plot](bm-20240926-linux-x86_64-python-de929f353c413459834a-3.14.0a0-de929f3-vs-3.12.6.svg)

### vs. 3.13.0rc2

- Geometric mean: 1.473x slower (HPT: reliability of 84.13%, 1.00x slower at 99th %ile)
- Memory usage: 1.11x
...
- [📄table](bm-20240926-linux-x86_64-python-de929f353c413459834a-3.14.0a0-de929f3-vs-3.13.0rc2.md)
- [📈time plot](bm-20240926-linux-x86_64-python-de929f353c413459834a-3.14.0a0-de929f3-vs-3.13.0rc2.svg)

### vs. base

- Geometric mean: 1.480x slower (HPT: reliability of 84.13%, 1.00x slower at 99th %ile)
- Memory usage: 1.10x
- [🧠memory plot](bm-20240926-linux-x86_64-python-de929f353c413459834a-3.14.0a0-de929f3-vs-base-mem.svg)
- [📄table](bm-20240926-linux-x86_64-python-de929f353c413459834a-3.14.0a0-de929f3-vs-base.md)
- [📈time plot](bm-20240926-linux-x86_64-python-de929f353c413459834a-3.14.0a0-de929f3-vs-base.svg)
