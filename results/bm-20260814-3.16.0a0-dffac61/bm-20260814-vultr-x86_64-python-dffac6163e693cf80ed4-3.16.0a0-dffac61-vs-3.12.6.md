...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260814-vultr-x86_64-python-dffac6163e693cf80ed4-3.16.0a0-dffac61 |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
...
| async_tree_none_tg         | 446 ms                                                 | 304 ms: 1.47x faster                                                  |
...
| bench_mp_pool              | 10.8 ms                                                | 249 ms: 23.09x slower                                                 |
| telco                      | 6.53 ms                                                | 164 ms: 25.05x slower                                                 |
| Geometric mean             | (ref)                                                  | 1.02x faster                                                          |

Benchmark hidden because not significant (4): richards_super, sqlite_synth, meteor_contest, 2to3
