...
- Geometric mean: 1.038x slower (HPT: reliability of 91.09%, 1.00x slower at 99th %ile)
- Memory usage: 1.41x
...
- Geometric mean: 1.074x slower (HPT: reliability of 99.67%, 1.01x slower at 99th %ile)
- Memory usage: 1.40x
...
- Memory usage: 1.19x
- [🧠memory plot](bm-20260606-vultr-x86_64-python-ab930175e7e909aaa3ec-3.16.0a0-ab93017-vs-base-mem.svg)
- [📄table](bm-20260606-vultr-x86_64-python-ab930175e7e909aaa3ec-3.16.0a0-ab93017-vs-base.md)
- [📈time plot](bm-20260606-vultr-x86_64-python-ab930175e7e909aaa3ec-3.16.0a0-ab93017-vs-base.svg)
