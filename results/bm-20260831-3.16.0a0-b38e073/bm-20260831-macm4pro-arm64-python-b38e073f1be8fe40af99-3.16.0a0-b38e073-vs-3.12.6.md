...
| nbody          | 54.2 ms                                                  | 42.8 ms: 1.27x faster                                                   |
...
| xml_etree_parse      | 67.9 ms                                                  | 72.9 ms: 1.07x slower                                                   |
...
| Benchmark              | bm-20240906-macm4pro-arm64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260831-macm4pro-arm64-python-b38e073f1be8fe40af99-3.16.0a0-b38e073 |
|------------------------|:--------------------------------------------------------:|:-----------------------------------------------------------------------:|
| python_startup         | 8.01 ms                                                  | 9.34 ms: 1.17x slower                                                   |
...
Benchmark hidden because not significant (4): json_loads, asyncio_websockets, regex_compile, create_gc_cycles
