...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260913-vultr-x86_64-python-12a1de1a4e22732700cf-3.16.0a0-12a1de1 |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
...
| bench_mp_pool              | 10.8 ms                                                | 249 ms: 23.06x slower                                                 |
| telco                      | 6.53 ms                                                | 159 ms: 24.37x slower                                                 |
| Geometric mean             | (ref)                                                  | 1.01x faster                                                          |

Benchmark hidden because not significant (4): richards_super, pidigits, pickle_pure_python, sqlite_synth
