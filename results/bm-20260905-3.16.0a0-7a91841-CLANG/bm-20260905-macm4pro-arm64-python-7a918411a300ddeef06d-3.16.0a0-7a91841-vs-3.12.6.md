...
| regex_dna      | 99.6 ms                                                  | 88.1 ms: 1.13x faster                                                   |
| regex_v8       | 9.59 ms                                                  | 8.92 ms: 1.07x faster                                                   |
...
| python_startup_no_site | 5.71 ms                                                  | 6.59 ms: 1.16x slower                                                   |
...
| 2to3                             | 114 ms                                                   | 119 ms: 1.04x slower                                                    |
| shortest_path                    | 219 ms                                                   | 229 ms: 1.04x slower                                                    |
