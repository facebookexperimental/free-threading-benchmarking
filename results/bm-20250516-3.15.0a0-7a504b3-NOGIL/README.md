...
- Geometric mean: 1.122x faster (HPT: reliability of 96.93%, 1.00x faster at 99th %ile)
- Memory usage: 1.41x
...
- Geometric mean: 1.082x faster (HPT: reliability of 91.49%, 1.00x faster at 99th %ile)
- Memory usage: 1.40x
...
- Memory usage: 1.21x
- [🧠memory plot](bm-20250516-linux-x86_64-python-7a504b3d5da988745368-3.15.0a0-7a504b3-vs-base-mem.svg)
- [📄table](bm-20250516-linux-x86_64-python-7a504b3d5da988745368-3.15.0a0-7a504b3-vs-base.md)
- [📈time plot](bm-20250516-linux-x86_64-python-7a504b3d5da988745368-3.15.0a0-7a504b3-vs-base.svg)
