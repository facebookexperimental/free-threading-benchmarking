...
| async_tree_cpu_io_mixed_tg | 723 ms                                                 | 558 ms: 1.30x faster                                                  |
| unpack_sequence            | 52.1 ns                                                | 41.5 ns: 1.25x faster                                                 |
...
| bench_mp_pool              | 10.8 ms                                                | 241 ms: 22.30x slower                                                 |
| telco                      | 6.53 ms                                                | 160 ms: 24.52x slower                                                 |
| Geometric mean             | (ref)                                                  | 1.02x faster                                                          |

Benchmark hidden because not significant (3): deltablue, coroutines, pickle_pure_python
