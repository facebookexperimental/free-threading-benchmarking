...
| async_tree_io                    | 459 ms                                                   | 314 ms: 1.47x faster                                                    |
| coroutines                       | 13.6 ms                                                  | 9.28 ms: 1.46x faster                                                   |
...
| coroutines                       | 13.6 ms                                                  | 9.28 ms: 1.46x faster                                                   |
| async_tree_io_tg                 | 480 ms                                                   | 330 ms: 1.46x faster                                                    |
| typing_runtime_protocols         | 71.0 us                                                  | 49.5 us: 1.43x faster                                                   |
| async_generators                 | 206 ms                                                   | 144 ms: 1.43x faster                                                    |
...
Benchmark hidden because not significant (4): pickle_pure_python, bench_thread_pool, asyncio_websockets, scimark_lu
