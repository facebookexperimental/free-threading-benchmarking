...
| regex_compile              | 142 ms                                                 | 149 ms: 1.04x slower                                                  |
| xml_etree_parse            | 139 ms                                                 | 145 ms: 1.04x slower                                                  |
| gc_traversal               | 3.46 ms                                                | 3.61 ms: 1.05x slower                                                 |
| asyncio_websockets         | 517 ms                                                 | 543 ms: 1.05x slower                                                  |
| xml_etree_process          | 59.0 ms                                                | 62.5 ms: 1.06x slower                                                 |
| mako                       | 11.0 ms                                                | 11.8 ms: 1.07x slower                                                 |
| python_startup_no_site     | 7.16 ms                                                | 7.72 ms: 1.08x slower                                                 |
...
| bench_mp_pool              | 10.8 ms                                                | 234 ms: 21.71x slower                                                 |
| telco                      | 6.53 ms                                                | 160 ms: 24.57x slower                                                 |
| Geometric mean             | (ref)                                                  | 1.02x faster                                                          |

Benchmark hidden because not significant (3): sqlite_synth, pickle_pure_python, fannkuch
