...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.13.0rc2-3.13.0rc2-ec61006 | bm-20260505-vultr-x86_64-nascheme-gc_ft_adapt-3.15.0a8+-67a2a66 |
|----------------|:------------------------------------------------------------:|:---------------------------------------------------------------:|
...
| async_tree_memoization     | 461 ms                                                       | 368 ms: 1.25x faster                                            |
...
| mako            | 11.3 ms                                                      | 16.4 ms: 1.45x slower                                           |
...
| hexiom                     | 5.99 ms                                                      | 6.62 ms: 1.11x slower                                           |
...
| coverage                   | 83.0 ms                                                      | 117 ms: 1.40x slower                                            |
| mako                       | 11.3 ms                                                      | 16.4 ms: 1.45x slower                                           |
| nbody                      | 85.1 ms                                                      | 126 ms: 1.48x slower                                            |
