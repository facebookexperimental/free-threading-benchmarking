...
| async_tree_cpu_io_mixed_tg | 723 ms                                                 | 546 ms: 1.32x faster                                                  |
...
| unpickle_list        | 4.67 us                                                | 4.39 us: 1.06x faster                                                 |
...
| pickle_list          | 4.77 us                                                | 5.44 us: 1.14x slower                                                 |
| pickle               | 10.9 us                                                | 13.8 us: 1.26x slower                                                 |
...
| richards_super             | 51.9 ms                                                | 44.1 ms: 1.17x faster                                                 |
| tomli_loads                | 2.11 sec                                               | 1.80 sec: 1.17x faster                                                |
| asyncio_tcp                | 519 ms                                                 | 443 ms: 1.17x faster                                                  |
| regex_compile              | 142 ms                                                 | 122 ms: 1.17x faster                                                  |
