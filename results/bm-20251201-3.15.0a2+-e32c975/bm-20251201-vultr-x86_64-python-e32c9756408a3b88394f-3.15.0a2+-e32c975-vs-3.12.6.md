...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20251201-vultr-x86_64-python-e32c9756408a3b88394f-3.15.0a2+-e32c975 |
|----------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
...
| asyncio_websockets         | 517 ms                                                 | 544 ms: 1.05x slower                                                   |
| fannkuch                   | 372 ms                                                 | 393 ms: 1.05x slower                                                   |
| regex_dna                  | 168 ms                                                 | 177 ms: 1.06x slower                                                   |
| json_loads                 | 26.5 us                                                | 28.4 us: 1.07x slower                                                  |
| mako                       | 11.0 ms                                                | 11.9 ms: 1.08x slower                                                  |
...
| bench_mp_pool              | 10.8 ms                                                | 317 ms: 29.40x slower                                                  |
