...
- Geometric mean: 1.034x slower (HPT: reliability of 82.35%, 1.00x slower at 99th %ile)
- Memory usage: 1.37x
...
- Memory usage: 1.19x
- [🧠memory plot](bm-20260731-vultr-x86_64-python-a646c99ee12fbf421394-3.16.0a0-a646c99-vs-base-mem.svg)
- [📄table](bm-20260731-vultr-x86_64-python-a646c99ee12fbf421394-3.16.0a0-a646c99-vs-base.md)
- [📈time plot](bm-20260731-vultr-x86_64-python-a646c99ee12fbf421394-3.16.0a0-a646c99-vs-base.svg)
