...
- Geometric mean: 1.025x slower (HPT: reliability of 68.43%, 1.00x slower at 99th %ile)
- Memory usage: 1.42x
...
- Geometric mean: 1.057x slower (HPT: reliability of 85.54%, 1.00x slower at 99th %ile)
- Memory usage: 1.41x
...
- Memory usage: 1.21x
- [🧠memory plot](bm-20260213-vultr-x86_64-python-fdbc135f9cf57599cca8-3.15.0a6%2B-fdbc135-vs-base-mem.svg)
- [📄table](bm-20260213-vultr-x86_64-python-fdbc135f9cf57599cca8-3.15.0a6%2B-fdbc135-vs-base.md)
- [📈time plot](bm-20260213-vultr-x86_64-python-fdbc135f9cf57599cca8-3.15.0a6%2B-fdbc135-vs-base.svg)
...
- Geometric mean: 1.093x faster (HPT: reliability of 99.89%, 1.00x faster at 99th %ile)
- Memory usage: 1.36x
...
- Geometric mean: 1.014x faster (HPT: reliability of 53.40%, 1.00x slower at 99th %ile)
- Memory usage: 1.31x
- missing benchmarks: chameleon, djangocms, gevent_hub, sqlalchemy_declarative, sqlalchemy_imperative, sqlglot_normalize, sqlglot_optimize, sqlglot_parse, sqlglot_transpile, tornado_http
- new benchmarks: sqlglot_v2_normalize, sqlglot_v2_optimize, sqlglot_v2_parse, sqlglot_v2_transpile
...
- Memory usage: 1.11x
- [🧠memory plot](bm-20260213-macm4pro-arm64-python-fdbc135f9cf57599cca8-3.15.0a6%2B-fdbc135-vs-base-mem.svg)
- [📄table](bm-20260213-macm4pro-arm64-python-fdbc135f9cf57599cca8-3.15.0a6%2B-fdbc135-vs-base.md)
- [📈time plot](bm-20260213-macm4pro-arm64-python-fdbc135f9cf57599cca8-3.15.0a6%2B-fdbc135-vs-base.svg)
