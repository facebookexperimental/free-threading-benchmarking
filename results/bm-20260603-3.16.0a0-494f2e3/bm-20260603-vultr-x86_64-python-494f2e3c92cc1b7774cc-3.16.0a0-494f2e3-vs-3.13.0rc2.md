...
| nbody          | 85.3 ms                                                                | 95.4 ms: 1.12x slower                                                 |
...
| regex_v8                   | 23.2 ms                                                                | 21.0 ms: 1.11x faster                                                 |
| tomli_loads                | 2.01 sec                                                               | 1.82 sec: 1.11x faster                                                |
| spectral_norm              | 108 ms                                                                 | 97.6 ms: 1.10x faster                                                 |
...
| telco                      | 7.77 ms                                                                | 161 ms: 20.67x slower                                                 |
| bench_mp_pool              | 11.0 ms                                                                | 251 ms: 22.86x slower                                                 |
| Geometric mean             | (ref)                                                                  | 1.02x slower                                                          |

Benchmark hidden because not significant (3): coverage, pycparser, scimark_sparse_mat_mult
