...
| async_tree_io              | 1.08 sec                                               | 779 ms: 1.39x faster                                                  |
| async_tree_memoization     | 555 ms                                                 | 401 ms: 1.38x faster                                                  |
...
| xml_etree_process    | 59.0 ms                                                | 62.7 ms: 1.06x slower                                                 |
| Geometric mean       | (ref)                                                  | 1.02x faster                                                          |
...
| bench_mp_pool              | 10.8 ms                                                | 247 ms: 22.85x slower                                                 |
