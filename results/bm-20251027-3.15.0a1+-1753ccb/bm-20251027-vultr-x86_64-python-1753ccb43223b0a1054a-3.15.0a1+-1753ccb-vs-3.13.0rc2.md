...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.13.0rc2-3.13.0rc2-ec61006 | bm-20251027-vultr-x86_64-python-1753ccb43223b0a1054a-3.15.0a1+-1753ccb |
|----------------|:------------------------------------------------------------:|:----------------------------------------------------------------------:|
...
| bench_thread_pool          | 919 us                                                       | 1.25 ms: 1.36x slower                                                  |
| create_gc_cycles           | 1.34 ms                                                      | 1.86 ms: 1.39x slower                                                  |
| telco                      | 7.82 ms                                                      | 160 ms: 20.43x slower                                                  |
| bench_mp_pool              | 11.0 ms                                                      | 283 ms: 25.74x slower                                                  |
| Geometric mean             | (ref)                                                        | 1.00x slower                                                           |

Benchmark hidden because not significant (4): sympy_sum, coroutines, regex_dna, typing_runtime_protocols
