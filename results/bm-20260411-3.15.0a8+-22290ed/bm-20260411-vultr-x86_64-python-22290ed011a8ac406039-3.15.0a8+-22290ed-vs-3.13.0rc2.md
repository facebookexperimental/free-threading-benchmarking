...
| bench_mp_pool              | 11.0 ms                                                      | 275 ms: 25.01x slower                                                  |
| Geometric mean             | (ref)                                                        | 1.01x slower                                                           |

Benchmark hidden because not significant (5): genshi_text, pprint_pformat, coverage, xml_etree_generate, sqlite_synth
