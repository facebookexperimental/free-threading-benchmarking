...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260423-vultr-x86_64-nascheme-ft_gc_threshold_fix_-3.15.0a8+-ac09833 |
|----------------|:------------------------------------------------------:|:------------------------------------------------------------------------:|
...
| Benchmark              | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260423-vultr-x86_64-nascheme-ft_gc_threshold_fix_-3.15.0a8+-ac09833 |
|------------------------|:------------------------------------------------------:|:------------------------------------------------------------------------:|
| python_startup_no_site | 7.16 ms                                                | 8.95 ms: 1.25x slower                                                    |
...
| python_startup             | 9.93 ms                                                | 15.5 ms: 1.56x slower                                                    |
| telco                      | 6.53 ms                                                | 172 ms: 26.38x slower                                                    |
| Geometric mean             | (ref)                                                  | 1.02x slower                                                             |
...
- Reliability score: 68.08% likely to be slow
