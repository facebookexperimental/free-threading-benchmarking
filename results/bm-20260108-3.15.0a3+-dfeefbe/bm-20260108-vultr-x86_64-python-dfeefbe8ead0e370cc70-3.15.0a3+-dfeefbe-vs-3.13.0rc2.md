...
| bench_mp_pool              | 11.0 ms                                                      | 368 ms: 33.46x slower                                                  |
| Geometric mean             | (ref)                                                        | 1.01x slower                                                           |

Benchmark hidden because not significant (6): logging_format, sympy_str, coroutines, meteor_contest, generators, genshi_xml
