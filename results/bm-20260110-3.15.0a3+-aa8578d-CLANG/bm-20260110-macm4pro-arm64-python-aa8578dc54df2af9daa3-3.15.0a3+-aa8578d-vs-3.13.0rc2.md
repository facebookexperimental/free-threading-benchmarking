...
| sphinx         | 409 ms                                                         | 380 ms: 1.07x faster                                                     |
...
| Benchmark      | bm-20240906-macm4pro-arm64-python-v3.13.0rc2-3.13.0rc2-ec61006 | bm-20260110-macm4pro-arm64-python-aa8578dc54df2af9daa3-3.15.0a3+-aa8578d |
|----------------|:--------------------------------------------------------------:|:------------------------------------------------------------------------:|
| regex_compile  | 47.9 ms                                                        | 43.1 ms: 1.11x faster                                                    |
...
| genshi_text     | 9.97 ms                                                        | 9.19 ms: 1.08x faster                                                    |
...
| deepcopy                         | 145 us                                                         | 94.0 us: 1.54x faster                                                    |
...
Benchmark hidden because not significant (2): scimark_fft, scimark_lu
