...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20251020-vultr-x86_64-Fidget%2dSpinner-tracing_jit-3.15.0a1+-754b3b7 |
|----------------|:------------------------------------------------------:|:-----------------------------------------------------------------------:|
...
| xml_etree_process    | 59.0 ms                                                | 52.4 ms: 1.12x faster                                                   |
...
| async_tree_io_tg           | 1.11 sec                                               | 607 ms: 1.83x faster                                                    |
| async_tree_io              | 1.08 sec                                               | 593 ms: 1.83x faster                                                    |
| deepcopy_memo              | 40.3 us                                                | 22.3 us: 1.80x faster                                                   |
| async_tree_none            | 464 ms                                                 | 258 ms: 1.80x faster                                                    |
| richards                   | 45.9 ms                                                | 29.0 ms: 1.58x faster                                                   |
| richards_super             | 51.9 ms                                                | 33.7 ms: 1.54x faster                                                   |
| async_tree_cpu_io_mixed_tg | 723 ms                                                 | 473 ms: 1.53x faster                                                    |
| async_tree_cpu_io_mixed    | 715 ms                                                 | 470 ms: 1.52x faster                                                    |
| deepcopy                   | 352 us                                                 | 236 us: 1.49x faster                                                    |
| logging_silent             | 109 ns                                                 | 78.6 ns: 1.39x faster                                                   |
| scimark_fft                | 342 ms                                                 | 247 ms: 1.39x faster                                                    |
...
| pprint_safe_repr           | 743 ms                                                 | 651 ms: 1.14x faster                                                    |
| pprint_pformat             | 1.52 sec                                               | 1.35 sec: 1.13x faster                                                  |
...
Benchmark hidden because not significant (3): genshi_xml, django_template, nqueens
