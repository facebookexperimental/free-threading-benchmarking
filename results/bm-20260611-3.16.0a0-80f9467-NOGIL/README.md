...
- Geometric mean: 1.030x slower (HPT: reliability of 85.21%, 1.00x slower at 99th %ile)
- Memory usage: 1.41x
...
- Geometric mean: 1.066x slower (HPT: reliability of 97.10%, 1.00x slower at 99th %ile)
- Memory usage: 1.40x
...
- Memory usage: 1.19x
- [🧠memory plot](bm-20260611-vultr-x86_64-python-80f9467434cecbc4e97b-3.16.0a0-80f9467-vs-base-mem.svg)
- [📄table](bm-20260611-vultr-x86_64-python-80f9467434cecbc4e97b-3.16.0a0-80f9467-vs-base.md)
- [📈time plot](bm-20260611-vultr-x86_64-python-80f9467434cecbc4e97b-3.16.0a0-80f9467-vs-base.svg)
