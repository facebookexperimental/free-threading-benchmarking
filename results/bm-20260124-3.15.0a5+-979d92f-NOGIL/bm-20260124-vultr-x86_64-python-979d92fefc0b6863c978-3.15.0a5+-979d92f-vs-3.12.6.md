...
| python_startup             | 9.93 ms                                                | 15.8 ms: 1.59x slower                                                  |
| telco                      | 6.53 ms                                                | 179 ms: 27.37x slower                                                  |
| Geometric mean             | (ref)                                                  | 1.03x slower                                                           |

Benchmark hidden because not significant (3): async_generators, raytrace, unpack_sequence
...
- Reliability score: 88.29% likely to be slow
