...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.13.0rc2-3.13.0rc2-ec61006 | bm-20251211-vultr-x86_64-python-387f88cac1e911672f63-3.15.0a2+-387f88c |
|----------------|:------------------------------------------------------------:|:----------------------------------------------------------------------:|
...
| async_tree_cpu_io_mixed    | 666 ms                                                       | 481 ms: 1.39x faster                                                   |
...
| bench_mp_pool              | 11.0 ms                                                      | 363 ms: 33.00x slower                                                  |
| Geometric mean             | (ref)                                                        | 1.01x slower                                                           |

Benchmark hidden because not significant (4): sympy_str, pycparser, logging_format, typing_runtime_protocols
