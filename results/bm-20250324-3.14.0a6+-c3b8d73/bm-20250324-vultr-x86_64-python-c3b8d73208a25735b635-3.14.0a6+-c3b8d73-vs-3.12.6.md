...
| async_tree_io_tg           | 1.11 sec                                               | 642 ms: 1.73x faster                                                   |
...
| bench_mp_pool              | 10.8 ms                                                | 90.1 ms: 8.34x slower                                                  |
| Geometric mean             | (ref)                                                  | 1.04x faster                                                           |

Benchmark hidden because not significant (5): meteor_contest, unpickle_pure_python, asyncio_websockets, sqlite_synth, genshi_xml
