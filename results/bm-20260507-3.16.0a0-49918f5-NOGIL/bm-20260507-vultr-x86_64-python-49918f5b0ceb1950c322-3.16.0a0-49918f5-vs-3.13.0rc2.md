...
| float          | 77.5 ms                                                      | 87.6 ms: 1.13x slower                                                 |
...
| xml_etree_generate   | 85.4 ms                                                      | 99.5 ms: 1.17x slower                                                 |
...
| deltablue                  | 3.12 ms                                                      | 3.94 ms: 1.26x slower                                                 |
| xml_etree_process          | 59.3 ms                                                      | 74.9 ms: 1.26x slower                                                 |
...
Benchmark hidden because not significant (3): spectral_norm, xml_etree_iterparse, bpe_tokeniser
