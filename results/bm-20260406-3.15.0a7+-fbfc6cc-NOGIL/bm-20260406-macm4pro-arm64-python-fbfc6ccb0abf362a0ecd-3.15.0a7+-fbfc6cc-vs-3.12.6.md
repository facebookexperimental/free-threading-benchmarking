...
| async_tree_io_tg                 | 480 ms                                                   | 235 ms: 2.05x faster                                                     |
...
| sqlite_synth                     | 967 ns                                                   | 778 ns: 1.24x faster                                                     |
| xml_etree_parse                  | 67.9 ms                                                  | 56.0 ms: 1.21x faster                                                    |
...
Benchmark hidden because not significant (4): xml_etree_process, dask, fannkuch, async_tree_eager
