...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260212-vultr-x86_64-python-46d5106cfa903329821c-3.15.0a6+-46d5106 |
|----------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
...
| bench_mp_pool              | 10.8 ms                                                | 247 ms: 22.87x slower                                                  |
| telco                      | 6.53 ms                                                | 155 ms: 23.68x slower                                                  |
| Geometric mean             | (ref)                                                  | 1.03x faster                                                           |

Benchmark hidden because not significant (4): pickle_pure_python, nqueens, xml_etree_process, coroutines
