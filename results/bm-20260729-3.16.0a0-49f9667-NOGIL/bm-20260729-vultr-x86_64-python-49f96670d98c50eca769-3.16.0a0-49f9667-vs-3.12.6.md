...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260729-vultr-x86_64-python-49f96670d98c50eca769-3.16.0a0-49f9667 |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
...
| async_tree_cpu_io_mixed    | 715 ms                                                 | 598 ms: 1.19x faster                                                  |
...
| scimark_sparse_mat_mult    | 4.39 ms                                                | 5.03 ms: 1.15x slower                                                 |
