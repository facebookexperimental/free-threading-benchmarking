...
| html5lib       | 67.0 ms                                                      | 68.0 ms: 1.01x slower                                                            |
...
| Benchmark                  | bm-20240906-vultr-x86_64-python-v3.13.0rc2-3.13.0rc2-ec61006 | bm-20251106-vultr-x86_64-Fidget%2dSpinner-tracing_jit_regalloc-3.15.0a1+-d47bed2 |
|----------------------------|:------------------------------------------------------------:|:--------------------------------------------------------------------------------:|
| async_tree_io              | 876 ms                                                       | 566 ms: 1.55x faster                                                             |
...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.13.0rc2-3.13.0rc2-ec61006 | bm-20251106-vultr-x86_64-Fidget%2dSpinner-tracing_jit_regalloc-3.15.0a1+-d47bed2 |
|----------------|:------------------------------------------------------------:|:--------------------------------------------------------------------------------:|
| float          | 77.5 ms                                                      | 61.6 ms: 1.26x faster                                                            |
...
| Benchmark            | bm-20240906-vultr-x86_64-python-v3.13.0rc2-3.13.0rc2-ec61006 | bm-20251106-vultr-x86_64-Fidget%2dSpinner-tracing_jit_regalloc-3.15.0a1+-d47bed2 |
|----------------------|:------------------------------------------------------------:|:--------------------------------------------------------------------------------:|
| json_dumps           | 10.5 ms                                                      | 9.09 ms: 1.16x faster                                                            |
...
| Benchmark                  | bm-20240906-vultr-x86_64-python-v3.13.0rc2-3.13.0rc2-ec61006 | bm-20251106-vultr-x86_64-Fidget%2dSpinner-tracing_jit_regalloc-3.15.0a1+-d47bed2 |
|----------------------------|:------------------------------------------------------------:|:--------------------------------------------------------------------------------:|
| richards                   | 45.2 ms                                                      | 20.3 ms: 2.23x faster                                                            |
| richards_super             | 51.6 ms                                                      | 24.3 ms: 2.12x faster                                                            |
...
| async_tree_memoization_tg  | 414 ms                                                       | 311 ms: 1.33x faster                                                             |
| async_tree_cpu_io_mixed_tg | 638 ms                                                       | 488 ms: 1.31x faster                                                             |
| spectral_norm              | 111 ms                                                       | 87.8 ms: 1.26x faster                                                            |
| float                      | 77.5 ms                                                      | 61.6 ms: 1.26x faster                                                            |
...
| nbody                      | 85.1 ms                                                      | 72.7 ms: 1.17x faster                                                            |
| logging_silent             | 103 ns                                                       | 88.1 ns: 1.16x faster                                                            |
| json_dumps                 | 10.5 ms                                                      | 9.09 ms: 1.16x faster                                                            |
| unpickle_pure_python       | 210 us                                                       | 185 us: 1.13x faster                                                             |
| xml_etree_iterparse        | 94.9 ms                                                      | 83.9 ms: 1.13x faster                                                            |
| tomli_loads                | 2.01 sec                                                     | 1.79 sec: 1.12x faster                                                           |
...
| json_loads                 | 27.0 us                                                      | 28.1 us: 1.04x slower                                                            |
| asyncio_websockets         | 520 ms                                                       | 545 ms: 1.05x slower                                                             |
| coverage                   | 83.0 ms                                                      | 87.9 ms: 1.06x slower                                                            |
...
Benchmark hidden because not significant (7): pylint, fannkuch, meteor_contest, sqlite_synth, genshi_text, dulwich_log, thrift
