...
- [GitHub Action run](https://github.com/facebookexperimental/free-threading-benchmarking/actions/runs/19134875057)
...
- Geometric mean: 1.062x faster (HPT: reliability of 99.98%, 1.02x faster at 99th %ile)
- Memory usage: 1.18x
...
- Geometric mean: 1.062x faster (HPT: reliability of 96.15%, 1.00x slower at 99th %ile)
- Memory usage: 1.02x
