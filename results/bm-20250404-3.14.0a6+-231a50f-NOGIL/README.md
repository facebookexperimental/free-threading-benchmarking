...
- [raw results](bm-20250404-linux-x86_64-python-231a50fa9a5444836c94-3.14.0a6%2B-231a50f.json)

### vs. 3.12.6

- Geometric mean: 1.031x faster (HPT: reliability of 82.50%, 1.00x slower at 99th %ile)
- Memory usage: 1.37x
- missing benchmarks: aiohttp, asyncio_tcp, asyncio_tcp_ssl, chameleon, dask, flaskblogging, gunicorn, mypy2, pickle, pickle_dict, pickle_list, sqlglot_normalize, sqlglot_optimize, sqlglot_parse, sqlglot_transpile, thrift, tornado_http, unpack_sequence, unpickle, unpickle_list
- new benchmarks: connected_components, k_core, many_optionals, shortest_path, sphinx, sqlglot_v2_normalize, sqlglot_v2_optimize, sqlglot_v2_parse, sqlglot_v2_transpile, subparsers
- [📄table](bm-20250404-linux-x86_64-python-231a50fa9a5444836c94-3.14.0a6%2B-231a50f-vs-3.12.6.md)
- [📈time plot](bm-20250404-linux-x86_64-python-231a50fa9a5444836c94-3.14.0a6%2B-231a50f-vs-3.12.6.svg)

### vs. 3.13.0rc2

- Geometric mean: 1.002x slower (HPT: reliability of 84.65%, 1.00x slower at 99th %ile)
- Memory usage: 1.36x
- missing benchmarks: aiohttp, asyncio_tcp, asyncio_tcp_ssl, chameleon, dask, flaskblogging, gunicorn, pickle, pickle_dict, pickle_list, sqlglot_normalize, sqlglot_optimize, sqlglot_parse, sqlglot_transpile, thrift, tornado_http, unpack_sequence, unpickle, unpickle_list
- new benchmarks: connected_components, k_core, many_optionals, shortest_path, sphinx, sqlalchemy_declarative, sqlalchemy_imperative, sqlglot_v2_normalize, sqlglot_v2_optimize, sqlglot_v2_parse, sqlglot_v2_transpile, subparsers
- [📄table](bm-20250404-linux-x86_64-python-231a50fa9a5444836c94-3.14.0a6%2B-231a50f-vs-3.13.0rc2.md)
- [📈time plot](bm-20250404-linux-x86_64-python-231a50fa9a5444836c94-3.14.0a6%2B-231a50f-vs-3.13.0rc2.svg)

### vs. base

- Geometric mean: 1.072x slower (HPT: reliability of 100.00%, 1.06x slower at 99th %ile)
- Memory usage: 1.20x
- new benchmarks: html5lib
- [🧠memory plot](bm-20250404-linux-x86_64-python-231a50fa9a5444836c94-3.14.0a6%2B-231a50f-vs-base-mem.svg)
- [📄table](bm-20250404-linux-x86_64-python-231a50fa9a5444836c94-3.14.0a6%2B-231a50f-vs-base.md)
- [📈time plot](bm-20250404-linux-x86_64-python-231a50fa9a5444836c94-3.14.0a6%2B-231a50f-vs-base.svg)
