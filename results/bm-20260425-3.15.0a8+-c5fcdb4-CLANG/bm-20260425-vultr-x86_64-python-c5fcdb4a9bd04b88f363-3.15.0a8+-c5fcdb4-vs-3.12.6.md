...
| nbody          | 89.3 ms                                                | 76.9 ms: 1.16x faster                                                  |
...
| spectral_norm              | 110 ms                                                 | 81.5 ms: 1.35x faster                                                  |
...
| richards                   | 45.9 ms                                                | 37.7 ms: 1.22x faster                                                  |
| tomli_loads                | 2.11 sec                                               | 1.74 sec: 1.21x faster                                                 |
| async_generators           | 384 ms                                                 | 320 ms: 1.20x faster                                                   |
...
| telco                      | 6.53 ms                                                | 151 ms: 23.11x slower                                                  |
| bench_mp_pool              | 10.8 ms                                                | 318 ms: 29.46x slower                                                  |
