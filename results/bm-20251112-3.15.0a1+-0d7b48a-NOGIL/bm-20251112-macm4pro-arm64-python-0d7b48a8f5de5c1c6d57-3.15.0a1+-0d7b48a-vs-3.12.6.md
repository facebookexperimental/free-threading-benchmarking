...
| json_dumps           | 4.26 ms                                                  | 4.12 ms: 1.03x faster                                                    |
...
Benchmark hidden because not significant (4): logging_format, async_tree_eager_memoization_tg, sympy_integrate, tomli_loads
