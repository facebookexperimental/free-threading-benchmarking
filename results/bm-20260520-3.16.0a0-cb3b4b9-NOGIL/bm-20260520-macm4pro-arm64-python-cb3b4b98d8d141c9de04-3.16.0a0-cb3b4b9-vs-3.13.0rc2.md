...
| async_tree_io                    | 386 ms                                                         | 273 ms: 1.42x faster                                                    |
...
Benchmark hidden because not significant (2): async_tree_none_tg, async_tree_eager_cpu_io_mixed
...
| subparsers                       | 6.26 ms                                                        | 4.26 ms: 1.47x faster                                                   |
...
| json_dumps                       | 4.65 ms                                                        | 3.90 ms: 1.19x faster                                                   |
| typing_runtime_protocols         | 64.6 us                                                        | 54.8 us: 1.18x faster                                                   |
| regex_v8                         | 10.7 ms                                                        | 9.14 ms: 1.17x faster                                                   |
| tomli_loads                      | 1000 ms                                                        | 855 ms: 1.17x faster                                                    |
...
Benchmark hidden because not significant (4): telco, async_tree_none_tg, html5lib, async_tree_eager_cpu_io_mixed
...
- Reliability score: 69.33% likely to be slow
