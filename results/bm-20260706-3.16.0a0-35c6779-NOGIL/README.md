...
- Geometric mean: 1.039x slower (HPT: reliability of 93.53%, 1.00x slower at 99th %ile)
- Memory usage: 1.37x
...
- Geometric mean: 1.072x slower (HPT: reliability of 99.82%, 1.01x slower at 99th %ile)
- Memory usage: 1.36x
...
- Memory usage: 1.18x
- [🧠memory plot](bm-20260706-vultr-x86_64-python-35c6779c7b5c4c2e2d97-3.16.0a0-35c6779-vs-base-mem.svg)
- [📄table](bm-20260706-vultr-x86_64-python-35c6779c7b5c4c2e2d97-3.16.0a0-35c6779-vs-base.md)
- [📈time plot](bm-20260706-vultr-x86_64-python-35c6779c7b5c4c2e2d97-3.16.0a0-35c6779-vs-base.svg)
