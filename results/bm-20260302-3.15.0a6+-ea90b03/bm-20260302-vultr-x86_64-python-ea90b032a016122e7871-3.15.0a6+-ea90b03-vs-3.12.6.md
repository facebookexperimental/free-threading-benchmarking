...
| tomli_loads                | 2.11 sec                                               | 1.84 sec: 1.15x faster                                                 |
| logging_silent             | 109 ns                                                 | 95.2 ns: 1.15x faster                                                  |
...
| bench_mp_pool              | 10.8 ms                                                | 290 ms: 26.90x slower                                                  |
| Geometric mean             | (ref)                                                  | 1.02x faster                                                           |

Benchmark hidden because not significant (2): coroutines, xml_etree_process
