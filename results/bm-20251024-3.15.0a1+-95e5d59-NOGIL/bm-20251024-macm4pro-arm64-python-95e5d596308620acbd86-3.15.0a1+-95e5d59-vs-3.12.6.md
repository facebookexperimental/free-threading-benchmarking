...
| comprehensions                   | 9.84 us                                                  | 8.54 us: 1.15x faster                                                    |
| regex_effbot                     | 1.67 ms                                                  | 1.45 ms: 1.15x faster                                                    |
...
| many_optionals                   | 195 us                                                   | 391 us: 2.00x slower                                                     |
| async_tree_eager_tg              | 32.1 ms                                                  | 78.9 ms: 2.45x slower                                                    |
| Geometric mean                   | (ref)                                                    | 1.07x faster                                                             |

Benchmark hidden because not significant (3): logging_format, async_tree_eager_memoization_tg, regex_v8
