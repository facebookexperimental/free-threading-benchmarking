...
| django_template                  | 12.5 ms                                                        | 15.1 ms: 1.21x slower                                                   |
| many_optionals                   | 200 us                                                         | 246 us: 1.22x slower                                                    |
| async_tree_eager_cpu_io_mixed_tg | 208 ms                                                         | 268 ms: 1.29x slower                                                    |
| async_tree_eager_memoization_tg  | 103 ms                                                         | 156 ms: 1.52x slower                                                    |
| async_tree_eager_tg              | 28.9 ms                                                        | 106 ms: 3.66x slower                                                    |
| Geometric mean                   | (ref)                                                          | 1.04x faster                                                            |

Benchmark hidden because not significant (8): async_tree_none_tg, async_tree_memoization, async_tree_cpu_io_mixed, sphinx, comprehensions, sympy_integrate, pidigits, json_loads
