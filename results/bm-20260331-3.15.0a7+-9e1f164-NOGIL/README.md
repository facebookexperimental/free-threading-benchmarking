...
- Geometric mean: 1.022x slower (HPT: reliability of 54.20%, 1.00x slower at 99th %ile)
- Memory usage: 1.44x
...
- Geometric mean: 1.054x slower (HPT: reliability of 80.73%, 1.00x slower at 99th %ile)
- Memory usage: 1.42x
...
- Memory usage: 1.21x
- [🧠memory plot](bm-20260331-vultr-x86_64-python-9e1f1644cd7b7661f074-3.15.0a7%2B-9e1f164-vs-base-mem.svg)
- [📄table](bm-20260331-vultr-x86_64-python-9e1f1644cd7b7661f074-3.15.0a7%2B-9e1f164-vs-base.md)
- [📈time plot](bm-20260331-vultr-x86_64-python-9e1f1644cd7b7661f074-3.15.0a7%2B-9e1f164-vs-base.svg)
...
- Geometric mean: 1.103x faster (HPT: reliability of 99.78%, 1.01x faster at 99th %ile)
- Memory usage: 1.38x
...
- Geometric mean: 1.023x faster (HPT: reliability of 59.96%, 1.00x faster at 99th %ile)
- Memory usage: 1.32x
- missing benchmarks: chameleon, djangocms, gevent_hub, sqlalchemy_declarative, sqlalchemy_imperative, sqlglot_normalize, sqlglot_optimize, sqlglot_parse, sqlglot_transpile, tornado_http
- new benchmarks: sqlglot_v2_normalize, sqlglot_v2_optimize, sqlglot_v2_parse, sqlglot_v2_transpile
...
- Memory usage: 1.12x
- [🧠memory plot](bm-20260331-macm4pro-arm64-python-9e1f1644cd7b7661f074-3.15.0a7%2B-9e1f164-vs-base-mem.svg)
- [📄table](bm-20260331-macm4pro-arm64-python-9e1f1644cd7b7661f074-3.15.0a7%2B-9e1f164-vs-base.md)
- [📈time plot](bm-20260331-macm4pro-arm64-python-9e1f1644cd7b7661f074-3.15.0a7%2B-9e1f164-vs-base.svg)
