...
| mako                             | 4.41 ms                                                        | 4.87 ms: 1.10x slower                                                    |
| coverage                         | 31.2 ms                                                        | 35.2 ms: 1.13x slower                                                    |
...
Benchmark hidden because not significant (7): genshi_text, scimark_sparse_mat_mult, logging_simple, deltablue, gc_traversal, logging_format, json
