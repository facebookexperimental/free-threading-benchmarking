...
| Benchmark              | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260419-vultr-x86_64-python-e50acef0b2c2057874a9-3.15.0a8+-e50acef |
|------------------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
| python_startup_no_site | 7.16 ms                                                | 6.84 ms: 1.05x faster                                                  |
...
| genshi_text                | 22.8 ms                                                | 21.3 ms: 1.07x faster                                                  |
| richards                   | 45.9 ms                                                | 43.1 ms: 1.06x faster                                                  |
| xml_etree_parse            | 139 ms                                                 | 130 ms: 1.06x faster                                                   |
| html5lib                   | 63.6 ms                                                | 59.8 ms: 1.06x faster                                                  |
| docutils                   | 2.64 sec                                               | 2.48 sec: 1.06x faster                                                 |
...
| bench_mp_pool              | 10.8 ms                                                | 271 ms: 25.10x slower                                                  |
| Geometric mean             | (ref)                                                  | 1.03x faster                                                           |

Benchmark hidden because not significant (4): typing_runtime_protocols, xml_etree_generate, sqlite_synth, json
