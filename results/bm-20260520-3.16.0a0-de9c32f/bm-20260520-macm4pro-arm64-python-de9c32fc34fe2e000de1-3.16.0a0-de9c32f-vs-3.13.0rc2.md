...
| async_tree_cpu_io_mixed_tg       | 301 ms                                                         | 286 ms: 1.06x faster                                                    |
...
| async_tree_eager_memoization_tg  | 103 ms                                                         | 151 ms: 1.47x slower                                                    |
| nqueens                          | 37.2 ms                                                        | 57.9 ms: 1.55x slower                                                   |
| async_tree_eager_tg              | 28.9 ms                                                        | 102 ms: 3.53x slower                                                    |
| Geometric mean                   | (ref)                                                          | 1.03x faster                                                            |

Benchmark hidden because not significant (3): dask, sympy_integrate, sphinx
