...
- Geometric mean: 1.036x slower (HPT: reliability of 84.93%, 1.00x slower at 99th %ile)
- Memory usage: 1.37x
...
- Geometric mean: 1.068x slower (HPT: reliability of 96.89%, 1.00x slower at 99th %ile)
- Memory usage: 1.36x
...
- Memory usage: 1.18x
- [🧠memory plot](bm-20260818-vultr-x86_64-python-af49df919dafc3767ae9-3.16.0a0-af49df9-vs-base-mem.svg)
- [📄table](bm-20260818-vultr-x86_64-python-af49df919dafc3767ae9-3.16.0a0-af49df9-vs-base.md)
- [📈time plot](bm-20260818-vultr-x86_64-python-af49df919dafc3767ae9-3.16.0a0-af49df9-vs-base.svg)
...
- Geometric mean: 1.013x faster (HPT: reliability of 69.50%, 1.00x slower at 99th %ile)
- Memory usage: 1.31x
...
- Geometric mean: 1.061x slower (HPT: reliability of 99.71%, 1.01x slower at 99th %ile)
- Memory usage: 1.27x
- missing benchmarks: chameleon, dask, djangocms, genshi_text, genshi_xml, gevent_hub, sqlalchemy_declarative, sqlalchemy_imperative, sqlglot_normalize, sqlglot_optimize, sqlglot_parse, sqlglot_transpile, tornado_http
- new benchmarks: sqlglot_v2_normalize, sqlglot_v2_optimize, sqlglot_v2_parse, sqlglot_v2_transpile
...
- [🧠memory plot](bm-20260818-macm4pro-arm64-python-af49df919dafc3767ae9-3.16.0a0-af49df9-vs-base-mem.svg)
- [📄table](bm-20260818-macm4pro-arm64-python-af49df919dafc3767ae9-3.16.0a0-af49df9-vs-base.md)
- [📈time plot](bm-20260818-macm4pro-arm64-python-af49df919dafc3767ae9-3.16.0a0-af49df9-vs-base.svg)
