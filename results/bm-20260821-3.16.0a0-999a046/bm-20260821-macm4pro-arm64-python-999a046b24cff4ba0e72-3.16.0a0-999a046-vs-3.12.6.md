...
| async_tree_eager_tg              | 32.1 ms                                                  | 105 ms: 3.28x slower                                                    |
...
| xml_etree_parse      | 67.9 ms                                                  | 69.7 ms: 1.03x slower                                                   |
...
| async_tree_io_tg                 | 480 ms                                                   | 335 ms: 1.43x faster                                                    |
| async_generators                 | 206 ms                                                   | 145 ms: 1.42x faster                                                    |
| typing_runtime_protocols         | 71.0 us                                                  | 50.0 us: 1.42x faster                                                   |
| coroutines                       | 13.6 ms                                                  | 9.90 ms: 1.37x faster                                                   |
| async_tree_none_tg               | 172 ms                                                   | 128 ms: 1.35x faster                                                    |
...
Benchmark hidden because not significant (5): json_loads, async_tree_eager_cpu_io_mixed, pycparser, thrift, asyncio_websockets
