...
| async_generators           | 377 ms                                                       | 333 ms: 1.13x faster                                                   |
| unpack_sequence            | 44.8 ns                                                      | 39.6 ns: 1.13x faster                                                  |
...
| bench_mp_pool              | 11.0 ms                                                      | 384 ms: 34.90x slower                                                  |
| Geometric mean             | (ref)                                                        | 1.01x slower                                                           |

Benchmark hidden because not significant (2): genshi_text, sympy_str
