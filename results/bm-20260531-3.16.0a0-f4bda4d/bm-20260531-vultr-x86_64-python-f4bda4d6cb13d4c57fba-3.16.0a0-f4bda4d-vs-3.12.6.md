...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260531-vultr-x86_64-python-f4bda4d6cb13d4c57fba-3.16.0a0-f4bda4d |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
...
| telco                      | 6.53 ms                                                | 165 ms: 25.34x slower                                                 |
| Geometric mean             | (ref)                                                  | 1.01x faster                                                          |

Benchmark hidden because not significant (3): scimark_lu, deltablue, thrift
