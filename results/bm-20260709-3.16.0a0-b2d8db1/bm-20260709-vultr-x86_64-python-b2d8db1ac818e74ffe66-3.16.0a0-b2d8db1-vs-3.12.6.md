...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260709-vultr-x86_64-python-b2d8db1ac818e74ffe66-3.16.0a0-b2d8db1 |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
...
| Benchmark              | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260709-vultr-x86_64-python-b2d8db1ac818e74ffe66-3.16.0a0-b2d8db1 |
|------------------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
| python_startup_no_site | 7.16 ms                                                | 6.96 ms: 1.03x faster                                                 |
...
| bench_mp_pool              | 10.8 ms                                                | 221 ms: 20.48x slower                                                 |
| telco                      | 6.53 ms                                                | 157 ms: 23.98x slower                                                 |
| Geometric mean             | (ref)                                                  | 1.03x faster                                                          |

Benchmark hidden because not significant (3): json, pickle_pure_python, fannkuch
