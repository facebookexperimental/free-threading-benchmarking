...
| json_dumps           | 10.4 ms                                                | 9.73 ms: 1.07x faster                                                 |
...
| pickle_list          | 4.77 us                                                | 5.91 us: 1.24x slower                                                 |
...
| unpack_sequence            | 52.1 ns                                                | 40.3 ns: 1.29x faster                                                 |
...
| bench_mp_pool              | 10.8 ms                                                | 286 ms: 26.53x slower                                                 |
| Geometric mean             | (ref)                                                  | 1.02x faster                                                          |

Benchmark hidden because not significant (3): sqlite_synth, thrift, scimark_lu
