...
| async_tree_eager_memoization_tg  | 103 ms                                                         | 152 ms: 1.48x slower                                                    |
| nqueens                          | 37.2 ms                                                        | 58.8 ms: 1.58x slower                                                   |
| async_tree_eager_tg              | 28.9 ms                                                        | 103 ms: 3.57x slower                                                    |
| Geometric mean                   | (ref)                                                          | 1.02x faster                                                            |

Benchmark hidden because not significant (8): sqlite_synth, richards_super, pprint_safe_repr, async_tree_eager_cpu_io_mixed, shortest_path, connected_components, regex_dna, sphinx
