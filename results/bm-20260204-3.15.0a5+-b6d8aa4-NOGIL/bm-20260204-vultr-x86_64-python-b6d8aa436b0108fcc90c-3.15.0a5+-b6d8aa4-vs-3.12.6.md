...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260204-vultr-x86_64-python-b6d8aa436b0108fcc90c-3.15.0a5+-b6d8aa4 |
|----------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
...
| logging_format             | 7.35 us                                                | 7.59 us: 1.03x slower                                                  |
| docutils                   | 2.64 sec                                               | 2.73 sec: 1.03x slower                                                 |
| regex_dna                  | 168 ms                                                 | 174 ms: 1.03x slower                                                   |
...
| python_startup             | 9.93 ms                                                | 15.9 ms: 1.60x slower                                                  |
| telco                      | 6.53 ms                                                | 173 ms: 26.43x slower                                                  |
