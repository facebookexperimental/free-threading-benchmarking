...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260725-vultr-x86_64-python-59e67c284d3e8dcb708e-3.16.0a0-59e67c2 |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
...
| richards_super             | 51.9 ms                                                | 51.5 ms: 1.01x faster                                                 |
| pickle_pure_python         | 308 us                                                 | 307 us: 1.00x faster                                                  |
| pidigits                   | 184 ms                                                 | 184 ms: 1.00x faster                                                  |
...
| bench_mp_pool              | 10.8 ms                                                | 275 ms: 25.49x slower                                                 |
| Geometric mean             | (ref)                                                  | 1.02x faster                                                          |
