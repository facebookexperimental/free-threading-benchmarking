...
- [GitHub Action run](https://github.com/facebookexperimental/free-threading-benchmarking/actions/runs/13275739825)
...
- Geometric mean: 1.039x slower (HPT: reliability of 99.98%, 1.03x slower at 99th %ile)
- Memory usage: 1.35x
