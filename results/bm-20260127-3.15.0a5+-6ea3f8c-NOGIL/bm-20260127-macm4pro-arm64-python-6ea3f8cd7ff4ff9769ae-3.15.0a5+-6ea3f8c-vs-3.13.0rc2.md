...
| deepcopy_memo                    | 16.5 us                                                        | 12.2 us: 1.34x faster                                                    |
| async_tree_memoization_tg        | 186 ms                                                         | 141 ms: 1.32x faster                                                     |
| async_tree_none                  | 142 ms                                                         | 112 ms: 1.28x faster                                                     |
| async_tree_none_tg               | 133 ms                                                         | 106 ms: 1.25x faster                                                     |
| async_tree_memoization           | 184 ms                                                         | 147 ms: 1.25x faster                                                     |
...
| pickle_pure_python               | 130 us                                                         | 142 us: 1.09x slower                                                     |
| python_startup                   | 8.63 ms                                                        | 9.62 ms: 1.11x slower                                                    |
| meteor_contest                   | 47.9 ms                                                        | 53.4 ms: 1.12x slower                                                    |
...
| sympy_sum                        | 52.3 ms                                                        | 58.8 ms: 1.12x slower                                                    |
| async_tree_eager_cpu_io_mixed_tg | 208 ms                                                         | 237 ms: 1.14x slower                                                     |
...
| nbody                            | 42.5 ms                                                        | 56.1 ms: 1.32x slower                                                    |
| scimark_lu                       | 42.8 ms                                                        | 58.5 ms: 1.37x slower                                                    |
...
- Reliability score: 84.54% likely to be faster
