...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260824-vultr-x86_64-python-ee521e8ac19ad012ebc4-3.16.0a0-ee521e8 |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
...
| regex_dna                  | 168 ms                                                 | 182 ms: 1.08x slower                                                  |
| mako                       | 11.0 ms                                                | 12.1 ms: 1.10x slower                                                 |
| coverage                   | 71.4 ms                                                | 85.5 ms: 1.20x slower                                                 |
| python_startup             | 9.93 ms                                                | 12.9 ms: 1.30x slower                                                 |
...
| bench_mp_pool              | 10.8 ms                                                | 299 ms: 27.71x slower                                                 |
| Geometric mean             | (ref)                                                  | 1.02x faster                                                          |

Benchmark hidden because not significant (3): thrift, nbody, sqlite_synth
