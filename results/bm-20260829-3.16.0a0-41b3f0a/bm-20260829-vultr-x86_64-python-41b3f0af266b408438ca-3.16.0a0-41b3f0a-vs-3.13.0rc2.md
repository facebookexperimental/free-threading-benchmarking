...
| telco                      | 7.82 ms                                                      | 163 ms: 20.90x slower                                                 |
| bench_mp_pool              | 11.0 ms                                                      | 242 ms: 21.98x slower                                                 |
| Geometric mean             | (ref)                                                        | 1.01x slower                                                          |

Benchmark hidden because not significant (9): regex_v8, meteor_contest, pycparser, sqlite_synth, pprint_pformat, json, thrift, coverage, logging_simple
