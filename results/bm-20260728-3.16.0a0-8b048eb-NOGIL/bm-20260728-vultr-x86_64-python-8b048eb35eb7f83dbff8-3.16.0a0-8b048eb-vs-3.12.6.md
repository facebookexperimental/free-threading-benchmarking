...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260728-vultr-x86_64-python-8b048eb35eb7f83dbff8-3.16.0a0-8b048eb |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
...
| float          | 80.8 ms                                                | 83.1 ms: 1.03x slower                                                 |
...
- Reliability score: 76.87% likely to be slow
