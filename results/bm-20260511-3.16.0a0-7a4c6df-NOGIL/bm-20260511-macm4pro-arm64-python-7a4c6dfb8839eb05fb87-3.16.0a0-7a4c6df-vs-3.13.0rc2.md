...
| sphinx         | 409 ms                                                         | 435 ms: 1.07x slower                                                    |
...
| Benchmark                        | bm-20240906-macm4pro-arm64-python-v3.13.0rc2-3.13.0rc2-ec61006 | bm-20260511-macm4pro-arm64-python-7a4c6dfb8839eb05fb87-3.16.0a0-7a4c6df |
|----------------------------------|:--------------------------------------------------------------:|:-----------------------------------------------------------------------:|
| async_tree_eager_io_tg           | 521 ms                                                         | 274 ms: 1.90x faster                                                    |
| async_tree_eager_io              | 525 ms                                                         | 278 ms: 1.89x faster                                                    |
| async_tree_io_tg                 | 405 ms                                                         | 270 ms: 1.50x faster                                                    |
...
| async_tree_none                  | 142 ms                                                         | 131 ms: 1.09x faster                                                    |
| async_tree_cpu_io_mixed_tg       | 301 ms                                                         | 279 ms: 1.08x faster                                                    |
| asyncio_websockets               | 194 ms                                                         | 179 ms: 1.08x faster                                                    |
...
| pylint                           | 106 ms                                                         | 52.6 ms: 2.01x faster                                                   |
...
| typing_runtime_protocols         | 64.6 us                                                        | 54.6 us: 1.18x faster                                                   |
| xml_etree_iterparse              | 46.1 ms                                                        | 39.0 ms: 1.18x faster                                                   |
| scimark_sor                      | 64.0 ms                                                        | 56.0 ms: 1.14x faster                                                   |
| bpe_tokeniser                    | 2.13 sec                                                       | 1.88 sec: 1.14x faster                                                  |
...
| comprehensions                   | 6.80 us                                                        | 8.04 us: 1.18x slower                                                   |
...
| scimark_lu                       | 42.8 ms                                                        | 60.6 ms: 1.42x slower                                                   |
| async_tree_eager_memoization_tg  | 103 ms                                                         | 155 ms: 1.51x slower                                                    |
| async_tree_eager_tg              | 28.9 ms                                                        | 109 ms: 3.78x slower                                                    |
