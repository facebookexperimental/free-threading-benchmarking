...
| async_tree_none            | 464 ms                                                 | 243 ms: 1.92x faster                                                   |
...
| richards                   | 45.9 ms                                                | 42.0 ms: 1.10x faster                                                  |
...
| bench_mp_pool              | 10.8 ms                                                | 319 ms: 29.50x slower                                                  |
| Geometric mean             | (ref)                                                  | 1.02x faster                                                           |

Benchmark hidden because not significant (2): xml_etree_process, nqueens
