...
| Benchmark      | bm-20240906-macm4pro-arm64-python-v3.13.0rc2-3.13.0rc2-ec61006 | bm-20251229-macm4pro-arm64-python-6cb245d26086369bb075-3.15.0a3+-6cb245d |
|----------------|:--------------------------------------------------------------:|:------------------------------------------------------------------------:|
...
| async_tree_io_tg                 | 405 ms                                                         | 224 ms: 1.80x faster                                                     |
...
| mako            | 4.41 ms                                                        | 4.14 ms: 1.07x faster                                                    |
...
| async_tree_eager_io              | 525 ms                                                         | 221 ms: 2.38x faster                                                     |
| async_tree_eager_io_tg           | 521 ms                                                         | 222 ms: 2.35x faster                                                     |
| richards                         | 22.1 ms                                                        | 9.75 ms: 2.26x faster                                                    |
...
| scimark_sor                      | 64.0 ms                                                        | 42.3 ms: 1.51x faster                                                    |
...
| scimark_fft                      | 124 ms                                                         | 102 ms: 1.22x faster                                                     |
| xml_etree_iterparse              | 46.1 ms                                                        | 38.6 ms: 1.20x faster                                                    |
| regex_compile                    | 47.9 ms                                                        | 40.4 ms: 1.19x faster                                                    |
| async_tree_cpu_io_mixed_tg       | 301 ms                                                         | 254 ms: 1.19x faster                                                     |
| async_tree_cpu_io_mixed          | 294 ms                                                         | 248 ms: 1.18x faster                                                     |
| telco                            | 3.07 ms                                                        | 2.61 ms: 1.17x faster                                                    |
| scimark_lu                       | 42.8 ms                                                        | 36.7 ms: 1.17x faster                                                    |
| pickle_pure_python               | 130 us                                                         | 112 us: 1.16x faster                                                     |
...
| mako                             | 4.41 ms                                                        | 4.14 ms: 1.07x faster                                                    |
| thrift                           | 309 us                                                         | 290 us: 1.07x faster                                                     |
