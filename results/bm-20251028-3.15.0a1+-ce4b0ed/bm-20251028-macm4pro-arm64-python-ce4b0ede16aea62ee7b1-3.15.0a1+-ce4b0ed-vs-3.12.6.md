...
| Benchmark      | bm-20240906-macm4pro-arm64-python-v3.12.6-3.12.6-a4a2d2b | bm-20251028-macm4pro-arm64-python-ce4b0ede16aea62ee7b1-3.15.0a1+-ce4b0ed |
|----------------|:--------------------------------------------------------:|:------------------------------------------------------------------------:|
...
| async_tree_eager_io_tg           | 446 ms                                                   | 228 ms: 1.96x faster                                                     |
...
| async_tree_eager_tg              | 32.1 ms                                                  | 82.4 ms: 2.56x slower                                                    |
...
| async_tree_cpu_io_mixed_tg       | 338 ms                                                   | 253 ms: 1.34x faster                                                     |
| coroutines                       | 13.6 ms                                                  | 10.2 ms: 1.33x faster                                                    |
| comprehensions                   | 9.84 us                                                  | 7.48 us: 1.31x faster                                                    |
| async_tree_cpu_io_mixed          | 333 ms                                                   | 254 ms: 1.31x faster                                                     |
| float                            | 37.9 ms                                                  | 29.0 ms: 1.31x faster                                                    |
| xml_etree_iterparse              | 51.6 ms                                                  | 39.8 ms: 1.30x faster                                                    |
...
| pidigits                         | 161 ms                                                   | 164 ms: 1.02x slower                                                     |
| mako                             | 4.77 ms                                                  | 4.86 ms: 1.02x slower                                                    |
| sqlite_synth                     | 967 ns                                                   | 985 ns: 1.02x slower                                                     |
| docutils                         | 1.02 sec                                                 | 1.05 sec: 1.02x slower                                                   |
| regex_v8                         | 9.59 ms                                                  | 9.88 ms: 1.03x slower                                                    |
...
| many_optionals                   | 195 us                                                   | 369 us: 1.89x slower                                                     |
| async_tree_eager_tg              | 32.1 ms                                                  | 82.4 ms: 2.56x slower                                                    |
| Geometric mean                   | (ref)                                                    | 1.11x faster                                                             |

Benchmark hidden because not significant (4): json, pprint_safe_repr, bench_thread_pool, json_loads
