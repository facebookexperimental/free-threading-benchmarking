...
- [GitHub Action run](https://github.com/facebookexperimental/free-threading-benchmarking/actions/runs/12320022901)
...
- Geometric mean: 1.001x faster (HPT: reliability of 99.56%, 1.00x slower at 99th %ile)
- Memory usage: 1.00x
