...
| Benchmark                  | bm-20240906-vultr-x86_64-python-v3.13.0rc2-3.13.0rc2-ec61006 | bm-20260321-vultr-x86_64-python-83360b5869a4981c87dc-3.15.0a7+-83360b5 |
|----------------------------|:------------------------------------------------------------:|:----------------------------------------------------------------------:|
| async_tree_io_tg           | 913 ms                                                       | 548 ms: 1.67x faster                                                   |
...
| nbody          | 85.1 ms                                                      | 77.4 ms: 1.10x faster                                                  |
...
| mdp                        | 2.36 sec                                                     | 1.19 sec: 1.98x faster                                                 |
...
| async_tree_none            | 354 ms                                                       | 234 ms: 1.51x faster                                                   |
| async_tree_none_tg         | 336 ms                                                       | 235 ms: 1.43x faster                                                   |
| spectral_norm              | 111 ms                                                       | 77.6 ms: 1.43x faster                                                  |
| async_tree_memoization_tg  | 414 ms                                                       | 290 ms: 1.43x faster                                                   |
| scimark_lu                 | 113 ms                                                       | 80.2 ms: 1.40x faster                                                  |
| go                         | 141 ms                                                       | 102 ms: 1.38x faster                                                   |
| tomli_loads                | 2.01 sec                                                     | 1.50 sec: 1.34x faster                                                 |
| scimark_fft                | 349 ms                                                       | 264 ms: 1.32x faster                                                   |
| async_tree_cpu_io_mixed    | 666 ms                                                       | 509 ms: 1.31x faster                                                   |
| float                      | 77.5 ms                                                      | 59.7 ms: 1.30x faster                                                  |
| logging_silent             | 103 ns                                                       | 79.7 ns: 1.29x faster                                                  |
...
| logging_simple             | 6.16 us                                                      | 5.11 us: 1.21x faster                                                  |
| async_tree_cpu_io_mixed_tg | 638 ms                                                       | 532 ms: 1.20x faster                                                   |
| deltablue                  | 3.12 ms                                                      | 2.66 ms: 1.18x faster                                                  |
| logging_format             | 6.84 us                                                      | 5.85 us: 1.17x faster                                                  |
...
| fannkuch                   | 370 ms                                                       | 341 ms: 1.08x faster                                                   |
| mako                       | 11.3 ms                                                      | 10.5 ms: 1.08x faster                                                  |
...
| bench_mp_pool              | 11.0 ms                                                      | 166 ms: 15.05x slower                                                  |
