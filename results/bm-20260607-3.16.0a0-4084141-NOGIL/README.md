...
- Geometric mean: 1.035x slower (HPT: reliability of 88.26%, 1.00x slower at 99th %ile)
- Memory usage: 1.41x
...
- Geometric mean: 1.072x slower (HPT: reliability of 97.87%, 1.00x slower at 99th %ile)
- Memory usage: 1.40x
...
- Memory usage: 1.18x
- [🧠memory plot](bm-20260607-vultr-x86_64-python-4084141073127669a779-3.16.0a0-4084141-vs-base-mem.svg)
- [📄table](bm-20260607-vultr-x86_64-python-4084141073127669a779-3.16.0a0-4084141-vs-base.md)
- [📈time plot](bm-20260607-vultr-x86_64-python-4084141073127669a779-3.16.0a0-4084141-vs-base.svg)
