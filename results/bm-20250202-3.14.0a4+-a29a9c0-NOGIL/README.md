...
- Geometric mean: 1.034x slower (HPT: reliability of 99.66%, 1.00x slower at 99th %ile)
- Memory usage: 1.35x
...
- Geometric mean: 1.070x slower (HPT: reliability of 99.99%, 1.03x slower at 99th %ile)
- Memory usage: 1.34x
...
- Memory usage: 1.19x
- [🧠memory plot](bm-20250202-linux-x86_64-python-a29a9c0f3890fec843b7-3.14.0a4%2B-a29a9c0-vs-base-mem.svg)
- [📄table](bm-20250202-linux-x86_64-python-a29a9c0f3890fec843b7-3.14.0a4%2B-a29a9c0-vs-base.md)
- [📈time plot](bm-20250202-linux-x86_64-python-a29a9c0f3890fec843b7-3.14.0a4%2B-a29a9c0-vs-base.svg)
