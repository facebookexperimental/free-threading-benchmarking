...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260730-vultr-x86_64-python-22fed93a21c36c032d87-3.16.0a0-22fed93 |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
...
| bench_mp_pool              | 10.8 ms                                                | 264 ms: 24.46x slower                                                 |
| Geometric mean             | (ref)                                                  | 1.02x faster                                                          |

Benchmark hidden because not significant (2): thrift, meteor_contest
