...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.13.0rc2-3.13.0rc2-ec61006 | bm-20260806-vultr-x86_64-python-c3aefdb9eff073405837-3.16.0a0-c3aefdb |
|----------------|:------------------------------------------------------------:|:---------------------------------------------------------------------:|
...
| bench_mp_pool              | 11.0 ms                                                      | 222 ms: 20.15x slower                                                 |
| telco                      | 7.82 ms                                                      | 159 ms: 20.30x slower                                                 |
| Geometric mean             | (ref)                                                        | 1.00x slower                                                          |

Benchmark hidden because not significant (3): pycparser, 2to3, coverage
