...
- Geometric mean: 1.030x slower (HPT: reliability of 76.42%, 1.00x slower at 99th %ile)
- Memory usage: 1.37x
...
- Geometric mean: 1.062x slower (HPT: reliability of 95.36%, 1.00x slower at 99th %ile)
- Memory usage: 1.36x
...
- Memory usage: 1.19x
- [🧠memory plot](bm-20260723-vultr-x86_64-python-206788a6dd23b79fc38f-3.16.0a0-206788a-vs-base-mem.svg)
- [📄table](bm-20260723-vultr-x86_64-python-206788a6dd23b79fc38f-3.16.0a0-206788a-vs-base.md)
- [📈time plot](bm-20260723-vultr-x86_64-python-206788a6dd23b79fc38f-3.16.0a0-206788a-vs-base.svg)
