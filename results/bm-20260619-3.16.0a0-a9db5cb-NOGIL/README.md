...
- Geometric mean: 1.036x slower (HPT: reliability of 92.81%, 1.00x slower at 99th %ile)
- Memory usage: 1.36x
...
- Geometric mean: 1.069x slower (HPT: reliability of 98.76%, 1.00x slower at 99th %ile)
- Memory usage: 1.34x
...
- Memory usage: 1.18x
- [🧠memory plot](bm-20260619-vultr-x86_64-python-a9db5cb52fefffc8fcdd-3.16.0a0-a9db5cb-vs-base-mem.svg)
- [📄table](bm-20260619-vultr-x86_64-python-a9db5cb52fefffc8fcdd-3.16.0a0-a9db5cb-vs-base.md)
- [📈time plot](bm-20260619-vultr-x86_64-python-a9db5cb52fefffc8fcdd-3.16.0a0-a9db5cb-vs-base.svg)
