...
- Geometric mean: 1.037x slower (HPT: reliability of 95.01%, 1.00x slower at 99th %ile)
- Memory usage: 1.36x
...
- Geometric mean: 1.070x slower (HPT: reliability of 98.50%, 1.00x slower at 99th %ile)
- Memory usage: 1.34x
...
- Geometric mean: 1.003x slower (HPT: reliability of 98.64%, 1.00x slower at 99th %ile)
- Memory usage: 1.02x
...
- Memory usage: 1.18x
- [📄table](bm-20260615-vultr-x86_64-python-11f032f904c8019b332a-3.16.0a0-11f032f-vs-default_base_vs_NOGIL.md)
- [📈time plot](bm-20260615-vultr-x86_64-python-11f032f904c8019b332a-3.16.0a0-11f032f-vs-default_base_vs_NOGIL.svg)
