...
- Geometric mean: 1.044x slower (HPT: reliability of 88.26%, 1.00x slower at 99th %ile)
- Memory usage: 1.37x
...
- Geometric mean: 1.076x slower (HPT: reliability of 98.23%, 1.00x slower at 99th %ile)
- Memory usage: 1.36x
...
- Memory usage: 1.19x
- [🧠memory plot](bm-20260908-vultr-x86_64-python-f8f8c30ed4e20208e8ba-3.16.0a0-f8f8c30-vs-base-mem.svg)
- [📄table](bm-20260908-vultr-x86_64-python-f8f8c30ed4e20208e8ba-3.16.0a0-f8f8c30-vs-base.md)
- [📈time plot](bm-20260908-vultr-x86_64-python-f8f8c30ed4e20208e8ba-3.16.0a0-f8f8c30-vs-base.svg)
...
- Geometric mean: 1.009x faster (HPT: reliability of 75.83%, 1.00x slower at 99th %ile)
- Memory usage: 1.31x
...
- Geometric mean: 1.066x slower (HPT: reliability of 99.81%, 1.01x slower at 99th %ile)
- Memory usage: 1.27x
- missing benchmarks: chameleon, dask, djangocms, genshi_text, genshi_xml, gevent_hub, sqlalchemy_declarative, sqlalchemy_imperative, sqlglot_normalize, sqlglot_optimize, sqlglot_parse, sqlglot_transpile, tornado_http
- new benchmarks: sqlglot_v2_normalize, sqlglot_v2_optimize, sqlglot_v2_parse, sqlglot_v2_transpile
...
- [🧠memory plot](bm-20260908-macm4pro-arm64-python-f8f8c30ed4e20208e8ba-3.16.0a0-f8f8c30-vs-base-mem.svg)
- [📄table](bm-20260908-macm4pro-arm64-python-f8f8c30ed4e20208e8ba-3.16.0a0-f8f8c30-vs-base.md)
- [📈time plot](bm-20260908-macm4pro-arm64-python-f8f8c30ed4e20208e8ba-3.16.0a0-f8f8c30-vs-base.svg)
