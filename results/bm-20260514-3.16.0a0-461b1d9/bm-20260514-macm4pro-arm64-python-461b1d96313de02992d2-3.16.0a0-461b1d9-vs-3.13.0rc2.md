...
| deepcopy                         | 145 us                                                         | 98.7 us: 1.47x faster                                                   |
...
| gc_traversal                     | 2.04 ms                                                        | 1.92 ms: 1.07x faster                                                   |
...
| pickle_pure_python               | 130 us                                                         | 143 us: 1.10x slower                                                    |
| crypto_pyaes                     | 33.6 ms                                                        | 39.8 ms: 1.18x slower                                                   |
...
| async_tree_eager_memoization_tg  | 103 ms                                                         | 150 ms: 1.46x slower                                                    |
| nqueens                          | 37.2 ms                                                        | 58.0 ms: 1.56x slower                                                   |
| async_tree_eager_tg              | 28.9 ms                                                        | 102 ms: 3.51x slower                                                    |
| Geometric mean                   | (ref)                                                          | 1.04x faster                                                            |

Benchmark hidden because not significant (4): sphinx, dask, connected_components, spectral_norm
