...
| asyncio_tcp                | 519 ms                                                 | 457 ms: 1.14x faster                                                   |
...
| unpickle_list        | 4.67 us                                                | 5.57 us: 1.19x slower                                                  |
...
Benchmark hidden because not significant (4): raytrace, logging_simple, regex_compile, docutils
...
- Reliability score: 59.66% likely to be slow
