...
| Benchmark      | bm-20240906-macm4pro-arm64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260915-macm4pro-arm64-python-9a1733d5712545db0703-3.16.0a0-9a1733d |
|----------------|:--------------------------------------------------------:|:-----------------------------------------------------------------------:|
...
| async_tree_eager_io              | 496 ms                                                   | 337 ms: 1.47x faster                                                    |
...
| async_tree_io                    | 459 ms                                                   | 337 ms: 1.36x faster                                                    |
...
| async_tree_eager_cpu_io_mixed    | 231 ms                                                   | 246 ms: 1.06x slower                                                    |
...
| Benchmark            | bm-20240906-macm4pro-arm64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260915-macm4pro-arm64-python-9a1733d5712545db0703-3.16.0a0-9a1733d |
|----------------------|:--------------------------------------------------------:|:-----------------------------------------------------------------------:|
| json_dumps           | 4.26 ms                                                  | 3.53 ms: 1.20x faster                                                   |
...
| create_gc_cycles                 | 830 us                                                   | 805 us: 1.03x faster                                                    |
| regex_v8                         | 9.59 ms                                                  | 9.32 ms: 1.03x faster                                                   |
