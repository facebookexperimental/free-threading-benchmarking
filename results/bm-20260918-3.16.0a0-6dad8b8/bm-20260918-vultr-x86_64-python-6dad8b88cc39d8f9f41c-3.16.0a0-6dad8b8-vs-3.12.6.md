...
| async_tree_io              | 1.08 sec                                               | 781 ms: 1.39x faster                                                  |
...
| async_tree_cpu_io_mixed_tg | 723 ms                                                 | 551 ms: 1.31x faster                                                  |
| async_tree_cpu_io_mixed    | 715 ms                                                 | 557 ms: 1.28x faster                                                  |
| spectral_norm              | 110 ms                                                 | 86.3 ms: 1.28x faster                                                 |
...
| bench_mp_pool              | 10.8 ms                                                | 288 ms: 26.65x slower                                                 |
| Geometric mean             | (ref)                                                  | 1.02x faster                                                          |

Benchmark hidden because not significant (4): thrift, fannkuch, sqlite_synth, scimark_sparse_mat_mult
