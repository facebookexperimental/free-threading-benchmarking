...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20251222-vultr-x86_64-chris%2deibl-msvc_tail_call_new-3.15.0a3+-da1adaf |
|----------------|:------------------------------------------------------:|:--------------------------------------------------------------------------:|
...
| bench_mp_pool              | 10.8 ms                                                | 373 ms: 34.58x slower                                                      |
| Geometric mean             | (ref)                                                  | 1.02x faster                                                               |

Benchmark hidden because not significant (2): tomli_loads, json
