...
- [GitHub Action run](https://github.com/facebookexperimental/free-threading-benchmarking/actions/runs/12399733496)
...
- Geometric mean: 1.024x faster (HPT: reliability of 93.59%, 1.00x faster at 99th %ile)
- Memory usage: 1.10x
...
- Geometric mean: 1.003x slower (HPT: reliability of 53.78%, 1.00x faster at 99th %ile)
- Memory usage: 1.00x
