...
- Geometric mean: 1.044x slower (HPT: reliability of 94.80%, 1.00x slower at 99th %ile)
- Memory usage: 1.36x
...
- Geometric mean: 1.077x slower (HPT: reliability of 99.85%, 1.01x slower at 99th %ile)
- Memory usage: 1.35x
...
- Memory usage: 1.18x
- [🧠memory plot](bm-20260712-vultr-x86_64-python-832bc0b0ea20c2fade5d-3.16.0a0-832bc0b-vs-base-mem.svg)
- [📄table](bm-20260712-vultr-x86_64-python-832bc0b0ea20c2fade5d-3.16.0a0-832bc0b-vs-base.md)
- [📈time plot](bm-20260712-vultr-x86_64-python-832bc0b0ea20c2fade5d-3.16.0a0-832bc0b-vs-base.svg)
