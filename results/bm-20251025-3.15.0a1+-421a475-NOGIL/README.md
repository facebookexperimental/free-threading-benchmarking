...
- Geometric mean: 1.020x slower (HPT: reliability of 92.56%, 1.00x slower at 99th %ile)
- Memory usage: 1.41x
...
- Geometric mean: 1.054x slower (HPT: reliability of 98.68%, 1.00x slower at 99th %ile)
- Memory usage: 1.39x
...
- Geometric mean: 1.082x faster (HPT: reliability of 97.18%, 1.00x faster at 99th %ile)
- Memory usage: 1.33x
...
- Geometric mean: 1.004x faster (HPT: reliability of 65.98%, 1.00x slower at 99th %ile)
- Memory usage: 1.29x
- missing benchmarks: chameleon, djangocms, gevent_hub, sqlalchemy_declarative, sqlalchemy_imperative, sqlglot_normalize, sqlglot_optimize, sqlglot_parse, sqlglot_transpile, tornado_http
- new benchmarks: asyncio_tcp, asyncio_tcp_ssl, pickle, pickle_dict, pickle_list, sqlglot_v2_normalize, sqlglot_v2_optimize, sqlglot_v2_parse, sqlglot_v2_transpile, unpack_sequence, unpickle, unpickle_list
