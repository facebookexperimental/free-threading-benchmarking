...
| k_core                           | 1.12 sec                                                 | 935 ms: 1.20x faster                                                     |
| tomli_loads                      | 957 ms                                                   | 808 ms: 1.18x faster                                                     |
...
| pprint_pformat                   | 665 ms                                                   | 579 ms: 1.15x faster                                                     |
...
| many_optionals                   | 195 us                                                   | 374 us: 1.92x slower                                                     |
| async_tree_eager_tg              | 32.1 ms                                                  | 83.5 ms: 2.60x slower                                                    |
| Geometric mean                   | (ref)                                                    | 1.12x faster                                                             |

Benchmark hidden because not significant (4): genshi_xml, json, nbody, html5lib
