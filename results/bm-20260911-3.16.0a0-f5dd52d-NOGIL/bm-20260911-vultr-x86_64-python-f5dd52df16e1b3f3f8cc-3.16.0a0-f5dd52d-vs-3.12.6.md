...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260911-vultr-x86_64-python-f5dd52df16e1b3f3f8cc-3.16.0a0-f5dd52d |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
...
| async_tree_none_tg         | 446 ms                                                 | 338 ms: 1.32x faster                                                  |
...
| Benchmark              | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260911-vultr-x86_64-python-f5dd52df16e1b3f3f8cc-3.16.0a0-f5dd52d |
|------------------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
| python_startup_no_site | 7.16 ms                                                | 9.99 ms: 1.40x slower                                                 |
| python_startup         | 9.93 ms                                                | 16.6 ms: 1.67x slower                                                 |
...
| generators                 | 32.2 ms                                                | 34.3 ms: 1.06x slower                                                 |
| html5lib                   | 63.6 ms                                                | 68.1 ms: 1.07x slower                                                 |
...
- Reliability score: 93.28% likely to be slow
