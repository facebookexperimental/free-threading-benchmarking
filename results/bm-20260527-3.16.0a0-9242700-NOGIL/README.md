...
- Geometric mean: 1.030x slower (HPT: reliability of 89.94%, 1.00x slower at 99th %ile)
- Memory usage: 1.41x
...
- Geometric mean: 1.066x slower (HPT: reliability of 98.08%, 1.00x slower at 99th %ile)
- Memory usage: 1.39x
...
- Memory usage: 1.18x
- [🧠memory plot](bm-20260527-vultr-x86_64-python-9242700c149c490c56d2-3.16.0a0-9242700-vs-base-mem.svg)
- [📄table](bm-20260527-vultr-x86_64-python-9242700c149c490c56d2-3.16.0a0-9242700-vs-base.md)
- [📈time plot](bm-20260527-vultr-x86_64-python-9242700c149c490c56d2-3.16.0a0-9242700-vs-base.svg)
