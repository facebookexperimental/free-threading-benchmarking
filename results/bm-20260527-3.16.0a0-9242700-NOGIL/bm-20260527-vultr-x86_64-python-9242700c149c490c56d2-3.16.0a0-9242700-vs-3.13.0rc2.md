...
| async_tree_io              | 881 ms                                                                 | 702 ms: 1.25x faster                                                  |
...
| pprint_safe_repr           | 719 ms                                                                 | 810 ms: 1.13x slower                                                  |
| json_loads                 | 27.3 us                                                                | 30.9 us: 1.13x slower                                                 |
...
Benchmark hidden because not significant (3): async_tree_none_tg, json_dumps, xml_etree_iterparse
