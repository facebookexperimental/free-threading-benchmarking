...
| bench_thread_pool          | 919 us                                                       | 1.36 ms: 1.47x slower                                                 |
| bench_mp_pool              | 11.0 ms                                                      | 223 ms: 20.32x slower                                                 |
| telco                      | 7.82 ms                                                      | 162 ms: 20.67x slower                                                 |
| Geometric mean             | (ref)                                                        | 1.01x slower                                                          |

Benchmark hidden because not significant (7): crypto_pyaes, regex_dna, richards_super, meteor_contest, richards, pycparser, coroutines
