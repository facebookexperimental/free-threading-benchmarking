...
| Benchmark                  | bm-20240906-vultr-x86_64-python-v3.13.0rc2-3.13.0rc2-ec61006 | bm-20260922-vultr-x86_64-python-6757482c25d4fa308d3f-3.16.0a0-6757482 |
|----------------------------|:------------------------------------------------------------:|:---------------------------------------------------------------------:|
| async_tree_io_tg           | 913 ms                                                       | 707 ms: 1.29x faster                                                  |
| async_tree_io              | 876 ms                                                       | 738 ms: 1.19x faster                                                  |
...
| coroutines                 | 23.6 ms                                                      | 26.3 ms: 1.12x slower                                                 |
...
| xml_etree_iterparse  | 94.9 ms                                                      | 96.9 ms: 1.02x slower                                                 |
...
| async_tree_io_tg           | 913 ms                                                       | 707 ms: 1.29x faster                                                  |
| pidigits                   | 217 ms                                                       | 182 ms: 1.19x faster                                                  |
| deepcopy_memo              | 39.1 us                                                      | 32.7 us: 1.19x faster                                                 |
| async_tree_io              | 876 ms                                                       | 738 ms: 1.19x faster                                                  |
...
| python_startup_no_site     | 7.39 ms                                                      | 9.73 ms: 1.32x slower                                                 |
| mako                       | 11.3 ms                                                      | 16.1 ms: 1.42x slower                                                 |
| coverage                   | 83.0 ms                                                      | 118 ms: 1.43x slower                                                  |
| nbody                      | 85.1 ms                                                      | 122 ms: 1.44x slower                                                  |
| python_startup             | 11.0 ms                                                      | 16.4 ms: 1.49x slower                                                 |
| bench_thread_pool          | 919 us                                                       | 1.49 ms: 1.62x slower                                                 |
| telco                      | 7.82 ms                                                      | 177 ms: 22.69x slower                                                 |
