...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20251222-vultr-x86_64-python-700e9fad70da3f1da008-3.15.0a3+-700e9fa |
|----------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
...
| bench_mp_pool              | 10.8 ms                                                | 356 ms: 32.93x slower                                                  |
| Geometric mean             | (ref)                                                  | 1.03x faster                                                           |
