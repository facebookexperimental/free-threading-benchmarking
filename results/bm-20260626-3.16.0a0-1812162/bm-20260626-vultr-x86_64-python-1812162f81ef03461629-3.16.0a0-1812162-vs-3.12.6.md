...
| async_tree_io_tg           | 1.11 sec                                               | 768 ms: 1.45x faster                                                  |
...
| bench_mp_pool              | 10.8 ms                                                | 228 ms: 21.16x slower                                                 |
| telco                      | 6.53 ms                                                | 158 ms: 24.28x slower                                                 |
| Geometric mean             | (ref)                                                  | 1.03x faster                                                          |

Benchmark hidden because not significant (2): coroutines, xml_etree_generate
