...
| telco                      | 6.53 ms                                                | 163 ms: 24.97x slower                                                  |
| bench_mp_pool              | 10.8 ms                                                | 315 ms: 29.19x slower                                                  |
| Geometric mean             | (ref)                                                  | 1.01x faster                                                           |

Benchmark hidden because not significant (2): deltablue, typing_runtime_protocols
