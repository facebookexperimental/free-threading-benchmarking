...
- Geometric mean: 1.040x slower (HPT: reliability of 95.70%, 1.00x slower at 99th %ile)
- Memory usage: 1.40x
...
- Geometric mean: 1.072x slower (HPT: reliability of 99.12%, 1.00x slower at 99th %ile)
- Memory usage: 1.39x
...
- Memory usage: 1.19x
- [🧠memory plot](bm-20251209-vultr-x86_64-python-b20722c300a78c384620-3.15.0a2%2B-b20722c-vs-base-mem.svg)
- [📄table](bm-20251209-vultr-x86_64-python-b20722c300a78c384620-3.15.0a2%2B-b20722c-vs-base.md)
- [📈time plot](bm-20251209-vultr-x86_64-python-b20722c300a78c384620-3.15.0a2%2B-b20722c-vs-base.svg)
