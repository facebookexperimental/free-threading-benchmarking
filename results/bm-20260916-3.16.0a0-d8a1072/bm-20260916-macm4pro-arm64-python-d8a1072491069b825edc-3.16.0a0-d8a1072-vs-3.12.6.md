...
| docutils       | 1.02 sec                                                 | 933 ms: 1.10x faster                                                    |
...
| coroutines                       | 13.6 ms                                                  | 9.40 ms: 1.44x faster                                                   |
...
| async_tree_none                  | 178 ms                                                   | 137 ms: 1.31x faster                                                    |
...
| python_startup_no_site | 5.71 ms                                                  | 6.65 ms: 1.16x slower                                                   |
...
Benchmark hidden because not significant (2): xml_etree_parse, bench_thread_pool
...
Ignored benchmarks (4) of results/bm-20260916-3.16.0a0-d8a1072/bm-20260916-macm4pro-arm64-python-d8a1072491069b825edc-3.16.0a0-d8a1072.json: sqlglot_v2_normalize, sqlglot_v2_optimize, sqlglot_v2_parse, sqlglot_v2_transpile
