...
| spectral_norm              | 110 ms                                                 | 79.1 ms: 1.39x faster                                                  |
...
| logging_format             | 7.35 us                                                | 6.09 us: 1.21x faster                                                  |
...
| unpickle_pure_python       | 221 us                                                 | 207 us: 1.07x faster                                                   |
| xml_etree_generate         | 85.2 ms                                                | 80.4 ms: 1.06x faster                                                  |
| fannkuch                   | 372 ms                                                 | 353 ms: 1.06x faster                                                   |
...
| telco                      | 6.53 ms                                                | 151 ms: 23.07x slower                                                  |
| bench_mp_pool              | 10.8 ms                                                | 296 ms: 27.37x slower                                                  |
