...
| async_tree_io_tg           | 913 ms                                                       | 587 ms: 1.56x faster                                                   |
| async_tree_memoization     | 461 ms                                                       | 299 ms: 1.54x faster                                                   |
| deepcopy_memo              | 39.1 us                                                      | 26.1 us: 1.49x faster                                                  |
...
| regex_effbot               | 3.08 ms                                                      | 2.68 ms: 1.15x faster                                                  |
| spectral_norm              | 111 ms                                                       | 98.1 ms: 1.13x faster                                                  |
| html5lib                   | 67.0 ms                                                      | 59.3 ms: 1.13x faster                                                  |
| xml_etree_iterparse        | 94.9 ms                                                      | 84.0 ms: 1.13x faster                                                  |
...
| bench_mp_pool              | 11.0 ms                                                      | 322 ms: 29.25x slower                                                  |
| Geometric mean             | (ref)                                                        | 1.01x slower                                                           |

Benchmark hidden because not significant (5): logging_format, meteor_contest, chaos, sympy_sum, sympy_str
Ignored benchmarks (18) of results/bm-20240906-3.13.0rc2-ec61006/bm-20240906-vultr-x86_64-python-v3.13.0rc2-3.13.0rc2-ec61006.json: aiohttp, asyncio_tcp, asyncio_tcp_ssl, chameleon, dask, flaskblogging, gunicorn, pickle, pickle_dict, pickle_list, sqlglot_normalize, sqlglot_optimize, sqlglot_parse, sqlglot_transpile, tornado_http, unpack_sequence, unpickle, unpickle_list
Ignored benchmarks (10) of results/bm-20251215-3.15.0a2+-bef63d2/bm-20251215-vultr-x86_64-python-bef63d2fb81ae2876004-3.15.0a2+-bef63d2.json: connected_components, k_core, many_optionals, shortest_path, sphinx, sqlglot_v2_normalize, sqlglot_v2_optimize, sqlglot_v2_parse, sqlglot_v2_transpile, subparsers
