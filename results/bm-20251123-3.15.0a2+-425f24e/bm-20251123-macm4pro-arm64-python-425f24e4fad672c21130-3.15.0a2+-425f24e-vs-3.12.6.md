...
| async_tree_none                  | 178 ms                                                   | 99.3 ms: 1.79x faster                                                    |
...
| pprint_pformat                   | 665 ms                                                   | 636 ms: 1.04x faster                                                     |
...
| many_optionals                   | 195 us                                                   | 352 us: 1.80x slower                                                     |
| async_tree_eager_tg              | 32.1 ms                                                  | 80.6 ms: 2.51x slower                                                    |
| Geometric mean                   | (ref)                                                    | 1.13x faster                                                             |

Benchmark hidden because not significant (3): sqlite_synth, docutils, json
