...
| pickle_list          | 4.93 us                                                      | 5.45 us: 1.11x slower                                                 |
...
| regex_v8                   | 22.7 ms                                                      | 22.0 ms: 1.03x faster                                                 |
| richards                   | 45.2 ms                                                      | 44.1 ms: 1.02x faster                                                 |
...
| bench_mp_pool              | 11.0 ms                                                      | 243 ms: 22.13x slower                                                 |
| Geometric mean             | (ref)                                                        | 1.01x slower                                                          |

Benchmark hidden because not significant (3): fannkuch, thrift, json
