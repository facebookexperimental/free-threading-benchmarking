...
Benchmark hidden because not significant (8): sphinx, docutils, json_loads, float, spectral_norm, xml_etree_generate, typing_runtime_protocols, xml_etree_process
