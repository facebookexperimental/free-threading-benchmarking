...
| json                       | 4.93 ms                                                      | 5.54 ms: 1.12x slower                                                  |
| pickle_pure_python         | 294 us                                                       | 334 us: 1.13x slower                                                   |
...
| nqueens                    | 78.6 ms                                                      | 92.7 ms: 1.18x slower                                                  |
| xml_etree_process          | 59.3 ms                                                      | 70.1 ms: 1.18x slower                                                  |
| genshi_xml                 | 48.8 ms                                                      | 57.7 ms: 1.18x slower                                                  |
...
Ignored benchmarks (10) of results/bm-20251217-3.15.0a3+-8b64dd8-JIT,NOGIL/bm-20251217-vultr-x86_64-python-8b64dd853ded593e1f0c-3.15.0a3+-8b64dd8.json: connected_components, k_core, many_optionals, shortest_path, sphinx, sqlglot_v2_normalize, sqlglot_v2_optimize, sqlglot_v2_parse, sqlglot_v2_transpile, subparsers
