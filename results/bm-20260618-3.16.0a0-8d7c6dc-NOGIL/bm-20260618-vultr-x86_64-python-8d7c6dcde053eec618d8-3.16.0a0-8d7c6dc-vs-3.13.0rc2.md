...
| async_tree_cpu_io_mixed_tg | 634 ms                                                                 | 605 ms: 1.05x faster                                                  |
...
| regex_compile              | 131 ms                                                                 | 141 ms: 1.07x slower                                                  |
| json_loads                 | 27.3 us                                                                | 30.0 us: 1.10x slower                                                 |
| scimark_sparse_mat_mult    | 4.75 ms                                                                | 5.27 ms: 1.11x slower                                                 |
...
| thrift                     | 772 us                                                                 | 940 us: 1.22x slower                                                  |
| python_startup_no_site     | 7.41 ms                                                                | 9.17 ms: 1.24x slower                                                 |
...
| telco                      | 7.77 ms                                                                | 177 ms: 22.75x slower                                                 |
