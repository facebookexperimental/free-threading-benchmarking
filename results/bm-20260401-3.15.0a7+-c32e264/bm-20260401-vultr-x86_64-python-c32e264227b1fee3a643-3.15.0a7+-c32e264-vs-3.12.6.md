...
| docutils       | 2.64 sec                                               | 2.45 sec: 1.07x faster                                                 |
...
| bench_mp_pool              | 10.8 ms                                                | 244 ms: 22.58x slower                                                  |
| telco                      | 6.53 ms                                                | 159 ms: 24.29x slower                                                  |
| Geometric mean             | (ref)                                                  | 1.04x faster                                                           |

Benchmark hidden because not significant (4): sqlite_synth, pidigits, pickle_pure_python, nbody
