...
| Benchmark      | bm-20240906-vultr-x86_64-python-v3.12.6-3.12.6-a4a2d2b | bm-20251117-vultr-x86_64-python-16ea9505ce690485bab3-3.15.0a1+-16ea950 |
|----------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
...
| mako                       | 11.0 ms                                                | 15.6 ms: 1.42x slower                                                  |
| bench_mp_pool              | 10.8 ms                                                | 15.8 ms: 1.47x slower                                                  |
...
Benchmark hidden because not significant (4): raytrace, pycparser, chaos, regex_compile
