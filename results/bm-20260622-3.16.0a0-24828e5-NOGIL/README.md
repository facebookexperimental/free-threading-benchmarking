...
- Geometric mean: 1.034x slower (HPT: reliability of 85.96%, 1.00x slower at 99th %ile)
- Memory usage: 1.36x
...
- Geometric mean: 1.068x slower (HPT: reliability of 97.98%, 1.00x slower at 99th %ile)
- Memory usage: 1.34x
...
- Memory usage: 1.18x
- [🧠memory plot](bm-20260622-vultr-x86_64-python-24828e57e17621fff166-3.16.0a0-24828e5-vs-base-mem.svg)
- [📄table](bm-20260622-vultr-x86_64-python-24828e57e17621fff166-3.16.0a0-24828e5-vs-base.md)
- [📈time plot](bm-20260622-vultr-x86_64-python-24828e57e17621fff166-3.16.0a0-24828e5-vs-base.svg)
