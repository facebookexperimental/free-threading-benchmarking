...
- Geometric mean: 1.030x slower (HPT: reliability of 77.96%, 1.00x slower at 99th %ile)
- Memory usage: 1.41x
...
- Geometric mean: 1.066x slower (HPT: reliability of 95.55%, 1.00x slower at 99th %ile)
- Memory usage: 1.40x
...
- Memory usage: 1.18x
- [🧠memory plot](bm-20260609-vultr-x86_64-python-ce916dc50644bb1de940-3.16.0a0-ce916dc-vs-base-mem.svg)
- [📄table](bm-20260609-vultr-x86_64-python-ce916dc50644bb1de940-3.16.0a0-ce916dc-vs-base.md)
- [📈time plot](bm-20260609-vultr-x86_64-python-ce916dc50644bb1de940-3.16.0a0-ce916dc-vs-base.svg)
