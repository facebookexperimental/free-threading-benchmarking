...
| float          | 76.7 ms                                                                | 87.8 ms: 1.14x slower                                                 |
...
| xml_etree_process    | 59.2 ms                                                                | 75.6 ms: 1.28x slower                                                 |
...
| deepcopy_reduce            | 3.12 us                                                                | 2.93 us: 1.06x faster                                                 |
...
| pickle_pure_python         | 292 us                                                                 | 342 us: 1.17x slower                                                  |
| django_template            | 34.2 ms                                                                | 40.5 ms: 1.18x slower                                                 |
| thrift                     | 772 us                                                                 | 915 us: 1.19x slower                                                  |
