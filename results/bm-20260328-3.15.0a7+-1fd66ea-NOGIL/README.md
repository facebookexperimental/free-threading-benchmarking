...
- Geometric mean: 1.023x slower (HPT: reliability of 73.51%, 1.00x slower at 99th %ile)
- Memory usage: 1.43x
...
- Geometric mean: 1.057x slower (HPT: reliability of 85.21%, 1.00x slower at 99th %ile)
- Memory usage: 1.41x
...
- Geometric mean: 1.100x faster (HPT: reliability of 99.55%, 1.00x faster at 99th %ile)
- Memory usage: 1.37x
...
- Geometric mean: 1.020x faster (HPT: reliability of 53.40%, 1.00x faster at 99th %ile)
- Memory usage: 1.32x
- missing benchmarks: chameleon, djangocms, gevent_hub, sqlalchemy_declarative, sqlalchemy_imperative, sqlglot_normalize, sqlglot_optimize, sqlglot_parse, sqlglot_transpile, tornado_http
- new benchmarks: asyncio_tcp, asyncio_tcp_ssl, pickle, pickle_dict, pickle_list, sqlglot_v2_normalize, sqlglot_v2_optimize, sqlglot_v2_parse, sqlglot_v2_transpile, unpack_sequence, unpickle, unpickle_list
