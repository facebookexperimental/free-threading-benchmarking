...
| Benchmark      | bm-20240906-macm4pro-arm64-python-v3.13.0rc2-3.13.0rc2-ec61006 | bm-20260520-macm4pro-arm64-python-de9c32fc34fe2e000de1-3.16.0a0-de9c32f |
|----------------|:--------------------------------------------------------------:|:-----------------------------------------------------------------------:|
...
| async_tree_eager_io              | 525 ms                                                         | 284 ms: 1.85x faster                                                    |
| async_tree_io                    | 386 ms                                                         | 275 ms: 1.41x faster                                                    |
| async_tree_io_tg                 | 405 ms                                                         | 293 ms: 1.38x faster                                                    |
...
| async_tree_memoization           | 184 ms                                                         | 181 ms: 1.02x faster                                                    |
...
| async_tree_eager_tg              | 28.9 ms                                                        | 106 ms: 3.66x slower                                                    |
...
| float          | 31.4 ms                                                        | 32.6 ms: 1.04x slower                                                   |
...
| sphinx                           | 409 ms                                                         | 442 ms: 1.08x slower                                                    |
| unpickle_pure_python             | 99.5 us                                                        | 108 us: 1.08x slower                                                    |
| nqueens                          | 37.2 ms                                                        | 40.4 ms: 1.09x slower                                                   |
...
Benchmark hidden because not significant (2): html5lib, async_tree_none_tg
