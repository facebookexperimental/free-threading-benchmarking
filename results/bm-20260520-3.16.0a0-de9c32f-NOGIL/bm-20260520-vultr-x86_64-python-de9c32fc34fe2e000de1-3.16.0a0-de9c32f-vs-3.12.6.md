...
| float          | 80.8 ms                                                | 88.5 ms: 1.10x slower                                                 |
...
| dulwich_log                | 78.9 ms                                                | 70.1 ms: 1.13x faster                                                 |
...
| scimark_monte_carlo        | 68.4 ms                                                | 80.3 ms: 1.17x slower                                                 |
| django_template            | 34.7 ms                                                | 41.0 ms: 1.18x slower                                                 |
| json_loads                 | 26.5 us                                                | 31.5 us: 1.19x slower                                                 |
| xml_etree_generate         | 85.2 ms                                                | 102 ms: 1.20x slower                                                  |
...
- Reliability score: 90.57% likely to be slow
