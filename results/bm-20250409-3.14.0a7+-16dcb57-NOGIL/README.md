...
- Geometric mean: 1.078x slower (HPT: reliability of 99.99%, 1.07x slower at 99th %ile)
- Memory usage: 1.37x
...
- Geometric mean: 1.108x slower (HPT: reliability of 99.99%, 1.07x slower at 99th %ile)
- Memory usage: 1.35x
...
- Geometric mean: 1.001x faster (HPT: reliability of 89.73%, 1.00x slower at 99th %ile)
- Memory usage: 1.01x
...
- [📄table](bm-20250409-vultr-x86_64-python-16dcb576f7623e19f22b-3.14.0a7%2B-16dcb57-vs-default_base_vs_NOGIL.md)
- [📈time plot](bm-20250409-vultr-x86_64-python-16dcb576f7623e19f22b-3.14.0a7%2B-16dcb57-vs-default_base_vs_NOGIL.svg)
