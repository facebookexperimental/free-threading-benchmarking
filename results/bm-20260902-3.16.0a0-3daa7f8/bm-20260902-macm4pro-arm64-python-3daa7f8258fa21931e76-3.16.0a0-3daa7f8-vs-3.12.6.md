...
| async_tree_io_tg                 | 480 ms                                                   | 332 ms: 1.45x faster                                                    |
...
| Benchmark      | bm-20240906-macm4pro-arm64-python-v3.12.6-3.12.6-a4a2d2b | bm-20260902-macm4pro-arm64-python-3daa7f8258fa21931e76-3.16.0a0-3daa7f8 |
|----------------|:--------------------------------------------------------:|:-----------------------------------------------------------------------:|
| nbody          | 54.2 ms                                                  | 42.0 ms: 1.29x faster                                                   |
...
| pylint                           | 128 ms                                                   | 57.4 ms: 2.23x faster                                                   |
...
Benchmark hidden because not significant (4): json_loads, asyncio_websockets, mako, create_gc_cycles
